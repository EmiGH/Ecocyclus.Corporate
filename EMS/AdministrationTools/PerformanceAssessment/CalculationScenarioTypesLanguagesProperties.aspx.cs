...
{
    public partial class CalculationScenarioTypesLanguagesProperties : BaseProperties
    {
        ...
        private Int64 _IdEntity
        {
            get
            {
                return base.NavigatorContainsTransferVar("IdScenarioType") ? base.NavigatorGetTransferVar<Int64>("IdScenarioType") : 0;
            }
        }
        ...
        private CalculationScenarioType_LG _EntityLanguage = null;
        private CalculationScenarioType_LG EntityLanguage
        {
            get
            {
        ...
        #region PageLoad & Init
            ...
            {
                base.PageTitle = (Entity != null) ? Entity.LanguageOption.Name + " - " + Global.Languages[_IdEntityLanguage].Name : Resources.CommonListManage.CalculationScenarioType;
            }
        ...
        #region Private Methods
            ...
            {
                Page.Title = Resources.CommonListManage.CalculationScenarioType_LG_Title;
