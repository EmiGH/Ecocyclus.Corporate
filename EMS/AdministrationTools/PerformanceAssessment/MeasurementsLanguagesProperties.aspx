<%@ Page Language="C#" MasterPageFile="~/EMS.Master" AutoEventWireup="true" CodeBehind="MeasurementsLanguagesProperties.aspx.cs"
    Inherits="Condesus.EMS.WebUI.PA.MeasurementsLanguagesProperties" Title="EMS - Measurement Language Option"
            ...
            <td>
                <table id="tblContentForm" runat="server" class="ContentForm">
                    ...
                    <tr>
                        ...
                        <td class="ColContent">
                            <asp:TextBox runat="server" ID="txtDescription" Rows="6" MaxLength="8000" TextMode="MultiLine"></asp:TextBox>
                        </td>
                        <td class="ColValidator">
                            &nbsp;
                        </td>
