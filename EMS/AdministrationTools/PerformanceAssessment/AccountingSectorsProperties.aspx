<%@ Page Title="" Language="C#" MasterPageFile="~/EMS.Master" AutoEventWireup="true" CodeBehind="AccountingSectorsProperties.aspx.cs" Inherits="Condesus.EMS.WebUI.AdministrationTools.PerformanceAssessment.AccountingSectorsProperties" %>
        ...
        <tr>
            <td>
                <table id="tblContentForm" runat="server" class="ContentForm">
                    ...
                    <!-- Parent Accounting Sector -->
                    <tr>
                        <td class="ColTitle">
                            <asp:Label ID="lblParentAccountingSector" runat="server" Text="Parent Accounting Sector:" />
                        </td>
                        <td class="ColContent">
                            <asp:PlaceHolder ID="phAccountingSector" runat="server" />
                        </td>
