...
{
    public partial class ConstantsLanguagesProperties : BaseProperties
    {
        #region Internal Properties
            private Int64 _IdEntity
            {
                get
                {
                    return base.NavigatorContainsTransferVar("IdConstant") ? base.NavigatorGetTransferVar<Int64>("IdConstant") : Convert.ToInt64(GetPKfromNavigator("IdConstant"));
                }
            }
            private Int64 _IdParentEntity
            {
                get
                {
                    return base.NavigatorContainsTransferVar("IdConstantClassification") ? base.NavigatorGetTransferVar<Int64>("IdConstantClassification") : Convert.ToInt64(GetPKfromNavigator("IdConstantClassification"));
                }
            }
            ...
            private Constant Entity
            {
                get
                {
                    if (_Entity == null)
                    {
                        _Entity = EMSLibrary.User.PerformanceAssessments.Configuration.ConstantClassification(_IdParentEntity).Constant(_IdEntity);
                    }
            ...
            private Constant_LG _EntityLanguage = null;
            private Constant_LG EntityLanguage
            {
                get
                {
        ...
        #region PageLoad & Init
            ...
            {
                base.PageTitle = (Entity != null) ? Entity.LanguageOption.Name + " - " + Global.Languages[_IdEntityLanguage].Name : Resources.CommonListManage.Constant;
            }
        ...
        #region Private Methods
            ...
            {
                Page.Title = Resources.CommonListManage.Constant_LG_Title;
