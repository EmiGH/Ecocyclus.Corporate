...
{
    public partial class ParameterGroupsLanguagesProperties : BaseProperties
    {
        ...
        private ParameterGroup Entity
        {
            get
            {
                if (_Entity == null)
                {
                    _Entity = EMSLibrary.User.PerformanceAssessments.Map.Indicator(_IdIndicator).ParameterGroup(_IdEntity);
                }
        ...
        private ParameterGroup_LG _EntityLanguage = null;
        private ParameterGroup_LG EntityLanguage
        {
            get
            {
        ...
        #region PageLoad & Init
            ...
            {
                base.PageTitle = (Entity != null) ? Entity.LanguageOption.Name + " - " + Global.Languages[_IdEntityLanguage].Name : Resources.CommonListManage.ParameterGroup;
            }
        ...
        #region Private Methods
            ...
            {
                Page.Title = Resources.CommonListManage.ParameterGroup_LG_Title;
