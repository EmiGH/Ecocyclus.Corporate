...
{
    public partial class AccountingActivitiesLanguagesProperties : BaseProperties
    {
        #region Internal Properties
            private Int64 _IdEntity
            {
                get
                {
                    return base.NavigatorContainsTransferVar("IdActivity") ? base.NavigatorGetTransferVar<Int64>("IdActivity") : 0;
                }
            }
            ...
            private AccountingActivity Entity
            {
                get
                {
                    if (_Entity == null)
                    {
                        _Entity = EMSLibrary.User.PerformanceAssessments.Configuration.AccountingActivity(_IdEntity);
                    }
            ...
            private AccountingActivity_LG _EntityLanguage = null;
            private AccountingActivity_LG EntityLanguage
            {
                get
                {
        ...
        #region PageLoad & Init
            ...
            {
                base.PageTitle = (Entity != null) ? Entity.LanguageOption.Name + " - " + Global.Languages[_IdEntityLanguage].Name : Resources.CommonListManage.AccountingActivity;
            }
