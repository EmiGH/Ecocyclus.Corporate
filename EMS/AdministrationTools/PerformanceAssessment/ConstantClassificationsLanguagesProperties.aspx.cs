...
{
    public partial class ConstantClassificationsLanguagesProperties : BaseProperties
    {
        #region Internal Properties
            ...
            private ConstantClassification Entity
            {
                get
                {
                    if (_Entity == null)
                    {
                        _Entity = EMSLibrary.User.PerformanceAssessments.Configuration.ConstantClassification(_IdEntity);
                    }
            ...
            private ConstantClassification_LG _EntityLanguage = null;
            private ConstantClassification_LG EntityLanguage
            {
                get
                {
        ...
        #region PageLoad & Init
            ...
            {
                base.PageTitle = (Entity != null) ? Entity.LanguageOption.Name + " - " + Global.Languages[_IdEntityLanguage].Name : Resources.CommonListManage.ConstantClassification;
            }
        ...
        #region Private Methods
            ...
            {
                Page.Title = Resources.CommonListManage.ConstantClassification_LG_Title;
