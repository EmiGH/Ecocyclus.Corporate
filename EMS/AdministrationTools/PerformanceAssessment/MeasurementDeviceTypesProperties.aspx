<%@ Page Language="C#" MasterPageFile="~/EMS.Master" AutoEventWireup="true" CodeBehind="MeasurementDeviceTypesProperties.aspx.cs"
    Inherits="Condesus.EMS.WebUI.PA.MeasurementDeviceTypesProperties" Title="EMS - Measurement Device Types Property"
                    ...
                    <tr>
                        ...
                        <td class="ColValidator">
                            <asp:RequiredFieldValidator SkinID="EMS" runat="server" ErrorMessage="Required Field"
                                ID="rfv1" ControlToValidate="txtName" Display="Dynamic"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <!-- Language -->
                    <tr>
