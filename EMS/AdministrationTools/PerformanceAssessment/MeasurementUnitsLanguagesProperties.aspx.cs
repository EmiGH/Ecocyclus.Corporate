...
{
    public partial class MeasurementUnitsLanguagesProperties : BaseProperties
    {
        ...
        //    }
        //}
        //GetPKfromNavigator("IdMagnitud")
        private Int64 _IdMagnitud
        {
            get
            {
                return base.NavigatorContainsTransferVar("IdMagnitud") ? base.NavigatorGetTransferVar<Int64>("IdMagnitud") : Convert.ToInt64(GetPKfromNavigator("IdMagnitud"));
            }
        }
        ...
        private MeasurementUnit_LG _EntityLanguage = null;
        private MeasurementUnit_LG EntityLanguage
        {
            get
            {
        ...
        #region PageLoad & Init
            ...
            {
                base.PageTitle = (Entity != null) ? Entity.LanguageOption.Name + " - " + Global.Languages[_IdEntityLanguage].Name : Resources.CommonListManage.MeasurementUnit;
            }
        ...
        #region Private Methods
            ...
            {
                Page.Title = Resources.CommonListManage.MeasurementUnit_LG_Title;
