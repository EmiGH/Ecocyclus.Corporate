...
{
    public partial class CalculationsLanguagesProperties : BaseProperties
    {
        ...
        private Int64 _IdEntity
        {
            get
            {
                return base.NavigatorContainsTransferVar("IdCalculation") ? base.NavigatorGetTransferVar<Int64>("IdCalculation") : 0;
            }
        }
        ...
        private Calculation Entity
        {
            get
            {
                if (_Entity == null)
                {
                    _Entity = EMSLibrary.User.PerformanceAssessments.Configuration.Calculation(_IdEntity);
                }
        ...
        private Calculation_LG _EntityLanguage = null;
        private Calculation_LG EntityLanguage
        {
            get
            {
        ...
        #region PageLoad & Init
            ...
            protected override void OnLoad(EventArgs e)
            {
                ...
                if (!Page.IsPostBack)
                {
                    ...
                    this.txtCalculation.Focus();
                }
            }
            protected override void SetPagetitle()
            {
                base.PageTitle = (Entity != null) ? Entity.LanguageOption.Name + " - " + Global.Languages[_IdEntityLanguage].Name : Resources.CommonListManage.Calculation;
            }
        ...
        #region Private Methods
            ...
            {
                Page.Title = Resources.CommonListManage.Calculation_LG_Title;
            ...
            private void LoadData()
            {
                ...
                txtCalculation.Text = EntityLanguage.Name;
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    //Alta
                    EntityLanguage = Entity.LanguagesOptions.Add(_IdEntityLanguage, txtCalculation.Text, txtDescription.Text);
                }
                else
                {
                    //Modificacion
                    EntityLanguage = Entity.LanguagesOptions.Modify(_IdEntityLanguage, txtCalculation.Text, txtDescription.Text);
                }
                base.NavigateBack();
