...
{
    public partial class CalculationOfTransformationsLanguagesProperties : BaseProperties
    {
        #region Internal Properties
            private Int64 _IdMeasurement
            {
                get
                {
                    return base.NavigatorContainsTransferVar("IdMeasurement") ? base.NavigatorGetTransferVar<Int64>("IdMeasurement") : Convert.ToInt64(GetPKfromNavigator("IdMeasurement"));
                }
            }
            private Int64 _IdEntity
            {
                get
                {
                    return base.NavigatorContainsTransferVar("IdTransformation") ? base.NavigatorGetTransferVar<Int64>("IdTransformation") : Convert.ToInt64(GetPKfromNavigator("IdTransformation"));
                }
            }
            ...
            private CalculateOfTransformation Entity
            {
                get
                {
                    if (_Entity == null)
                    {
                        _Entity = EMSLibrary.User.PerformanceAssessments.Configuration.Measurement(_IdMeasurement).Transformation(_IdEntity);
                    }
            ...
            private CalculateOfTransformation_LG _EntityLanguage = null;
            private CalculateOfTransformation_LG EntityLanguage
            {
                get
                {
        ...
        #region PageLoad & Init
            ...
            {
                base.PageTitle = (Entity != null) ? Entity.LanguageOption.Name + " - " + Global.Languages[_IdEntityLanguage].Name : Resources.CommonListManage.Transformation;
            }
