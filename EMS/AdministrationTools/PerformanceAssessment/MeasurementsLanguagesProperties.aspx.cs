...
{
    public partial class MeasurementsLanguagesProperties : BaseProperties
    {
        ...
        private Int64 _IdEntity
        {
            get
            {
                return base.NavigatorContainsTransferVar("IdMeasurement") ? base.NavigatorGetTransferVar<Int64>("IdMeasurement") : 0;
            }
        }
        ...
        private Measurement _Entity = null;
        private Measurement Entity
        {
            get
            {
                if (_Entity == null)
                {
                    _Entity = EMSLibrary.User.PerformanceAssessments.Configuration.Measurement(_IdEntity);
                }
        ...
        private Measurement_LG _EntityLanguage = null;
        private Measurement_LG EntityLanguage
        {
            get
            {
        ...
        #region PageLoad & Init
            ...
            {
                base.PageTitle = (Entity != null) ? Entity.LanguageOption.Name + " - " + Global.Languages[_IdEntityLanguage].Name : Resources.CommonListManage.Measurement;
            }
        ...
        #region Private Methods
            ...
            {
                Page.Title = Resources.CommonListManage.Measurement_LG_Title;
