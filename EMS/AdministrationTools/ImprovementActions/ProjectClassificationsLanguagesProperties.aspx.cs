...
{
    public partial class ProjectClassificationsLanguagesProperties : BaseProperties
    {
        ...
        private Int64 _IdEntity
        {
            get
            {
                return base.NavigatorContainsTransferVar("IdProjectClassification") ? base.NavigatorGetTransferVar<Int64>("IdProjectClassification") : 0;
            }
        }
        ...
        private ProjectClassification_LG _EntityLanguage = null;
        private ProjectClassification_LG EntityLanguage
        {
            get
            {
        ...
        #region PageLoad & Init
            ...
            {
                base.PageTitle = (Entity != null) ? Entity.LanguageOption.Name + " - " + Global.Languages[_IdEntityLanguage].Name : Resources.CommonListManage.ProjectClassification;
            }
        ...
        {
            Page.Title = Resources.CommonListManage.ProjectClassification_LG_Title;
