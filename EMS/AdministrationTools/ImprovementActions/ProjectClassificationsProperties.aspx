<%@ Page Language="C#" MasterPageFile="~/EMS.Master" AutoEventWireup="true" CodeBehind="ProjectClassificationsProperties.aspx.cs"
    Inherits="Condesus.EMS.WebUI.IA.ProjectClassificationsProperties" Title="EMS - Project Classification Property"
        ...
        <tr>
            <td>
                <table id="tblContentForm" runat="server" class="ContentForm">
                    ...
                    <!-- Parent Project Classification -->
                    <tr>
                        <td class="ColTitle">
                            <asp:Label ID="lblParentProjectClassification" runat="server" Text="Parent Project Classification:" />
                        </td>
                        <td class="ColContent">
                    ...
                    <tr>
                        ...
                        <td class="ColContent">
                            <asp:TextBox ID="txtDescription" runat="server" Rows="6" TextMode="MultiLine" MaxLength="8000"></asp:TextBox>
                        </td>
                        <td class="ColValidator">
                            &nbsp;
                        </td>
