<%@ Page Title="" Language="C#" MasterPageFile="~/EMS.Master" AutoEventWireup="true"
    CodeBehind="OrganizationalChartsProperties.aspx.cs" Inherits="Condesus.EMS.WebUI.DS.OrganizationalChartsProperties" %>
            ...
            <td>
                <table id="tblContentForm" runat="server" class="ContentForm">
                    ...
                    <tr>
                        ...
                        <td class="ColContent">
                            <asp:Label ID="lblOrganizationValue" runat="server" Text="Organization:" />
                        </td>
                    ...
                    <tr>
                        <td class="ColTitle">
                            <asp:Label ID="lblName" runat="server" Text="Organizational Chart:" />
                        </td>
                        <td class="ColContent">
