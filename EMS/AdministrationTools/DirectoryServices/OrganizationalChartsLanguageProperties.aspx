...
CodeBehind="OrganizationalChartsLanguageProperties.aspx.cs" Inherits="Condesus.EMS.WebUI.DS.OrganizationalChartsLanguageProperties" %>
            ...
            <td>
                <table id="tblContentForm" runat="server" class="ContentForm">
                    ...
                    <tr>
                        ...
                        <td class="ColContent">
                            <asp:TextBox runat="server"  ID="txtOrganizationalChart" MaxLength="150"></asp:TextBox>
                        </td>
                        <td class="ColValidator">
                            <asp:RequiredFieldValidator ID="rfv1"  runat="server" Display="Dynamic"
                                ErrorMessage="Required Field" ControlToValidate="txtOrganizationalChart"  SkinID="EMS"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <!-- Description -->
                    <tr>
