...
CodeBehind="SectorsLanguagesProperties.aspx.cs" 
Inherits="Condesus.EMS.WebUI.AdministrationTools.DirectoryServices.SectorsLanguagesProperties" %>
            ...
            <td>
                <table id="tblContentForm" runat="server" class="ContentForm">
                    ...
                    <tr>
                        ...
                        <td class="ColContent">
                            <asp:Label ID="lblFacilityValue" runat="server" />
                        </td>
                        <td class="ColValidator">
                            &nbsp;
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="ColContent">
                            <asp:TextBox runat="server" ID="txtSector" MaxLength="150"></asp:TextBox>
                        </td>
                        <td class="ColValidator">
                            <asp:RequiredFieldValidator ID="rfv1" runat="server" Display="Dynamic" ErrorMessage="Required Field"
                                ControlToValidate="txtSector" SkinID="EMS"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <!-- Description -->
                    <tr>
