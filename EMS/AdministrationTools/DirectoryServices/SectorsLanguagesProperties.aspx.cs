...
{
    public partial class SectorsLanguagesProperties : BaseProperties
    {
        #region Internal Properties
            ...
            private Sector Entity
            {
                get
                {
                    if (_Entity == null)
                    {
                        _Entity = EMSLibrary.User.DirectoryServices.Map.Organization(_IdOrganization).Facility(_IdFacility).Sector(_IdEntity);
                    }
        ...
        #region PageLoad & Init
            ...
            {
                base.PageTitle = (Entity != null) ? Entity.LanguageOption.Name + " - " + Global.Languages[_IdEntityLanguage].Name : Resources.CommonListManage.Sector;
            }
        ...
        #region Private Methods
            ...
            {
                Page.Title = Resources.CommonListManage.Sector_LG_Title;
            ...
            private void LoadData()
            {
                ...
                txtSector.Text = EntityLanguage.Name;
        ...
        #region Page Events
            protected void btnSave_Click(object sender, EventArgs e)
            {
                try
                {
                    ...
                    {
                        //Alta
                        EntityLanguage = Entity.LanguagesOptions.Add(_IdEntityLanguage, txtSector.Text, txtDescription.Text);
                    }
                    else
                    {
                        //Modificacion
                        EntityLanguage = Entity.LanguagesOptions.Modify(_IdEntityLanguage, txtSector.Text, txtDescription.Text);
                    }
                    base.NavigateBack();
