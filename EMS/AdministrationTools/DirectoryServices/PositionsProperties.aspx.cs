...
{
    public partial class PositionsProperties : BaseProperties
    {
        #region Internal Properties

        private Position _Entity = null;
        ...
        private Int64 _IdEntity
        {
            get
            {
                return base.NavigatorContainsTransferVar("IdPosition") ? base.NavigatorGetTransferVar<Int64>("IdPosition") : 0;
            }
        }
        ...
        private Position Entity
        {
            get
            {
                ...
                {
                    if (_Entity == null)
                        _Entity = EMSLibrary.User.DirectoryServices.Map.Organization(_IdOrganization).Position(_IdEntity);
        ...
        #region PageLoad & Init
            ...
            {
                base.PageTitle = (Entity != null) ? Entity.LanguagesOptions.Item(Global.DefaultLanguage.IdLanguage).Name : Resources.CommonListManage.Position;
            }
        ...
        #region Private Methods
            ...
            {
                Page.Title = Resources.CommonListManage.Position;
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    //Alta
                    Entity = EMSLibrary.User.DirectoryServices.Map.Organization(_IdOrganization).PositionsAdd(txtName.Text, txtDescription.Text);
                }
                else
                {
                    //Modificacion
                    EMSLibrary.User.DirectoryServices.Map.Organization(_IdOrganization).PositionsModify(Entity, txtName.Text, txtDescription.Text);
                }
                String _pkValues = "IdPosition=" + Entity.IdPosition.ToString()
                        + "& IdOrganization=" + Entity.IdOrganization.ToString();
                base.NavigatorAddPkEntityIdTransferVar("PkCompost", _pkValues);

                base.NavigatorAddTransferVar("EntityName", Common.ConstantsEntitiesName.DS.Position);
                base.NavigatorAddTransferVar("EntityNameContextInfo", Common.ConstantsEntitiesName.DS.Organization);
                //Navigate("~/MainInfo/ListViewer.aspx", Resources.CommonListManage.Position + " " + Entity.LanguageOption.Name, Condesus.WebUI.Navigation.DeleteType.DeleteModifiedEntity);
                String _entityPropertyName = String.Concat(Entity.LanguageOption.Name);
                NavigatePropertyEntity(Common.ConstantsEntitiesName.DS.Position, _entityPropertyName, Condesus.WebUI.Navigation.NavigateMenuAction.Add);
