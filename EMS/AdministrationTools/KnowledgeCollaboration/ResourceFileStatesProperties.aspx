<%@ Page Language="C#" MasterPageFile="~/EMS.Master" AutoEventWireup="true" CodeBehind="ResourceFileStatesProperties.aspx.cs"
    Inherits="Condesus.EMS.WebUI.KC.ResourceFileStatesProperties" Title="EMS - Resource File State Property"
        ...
        <tr>
            <td>
                <table id="tblContentForm" runat="server" class="ContentForm">
                    ...
                    <tr>
                        <td class="ColTitle">
                            <asp:Label ID="lblName" runat="server" Text="Resource File State:" />
                        </td>
                        <td class="ColContent">
