...
{
    public partial class ResourceClassificationsLanguagesProperties : BaseProperties
    {
        ...
        private Int64 _IdEntity
        {
            get
            {
                return base.NavigatorContainsTransferVar("IdResourceClassification") ? base.NavigatorGetTransferVar<Int64>("IdResourceClassification") : 0;
            }
        }
        ...
        private ResourceClassification_LG _EntityLanguage = null;
        private ResourceClassification_LG EntityLanguage
        {
            get
            {
        ...
        #region PageLoad & Init
            ...
            {
                base.PageTitle = (Entity != null) ? Entity.LanguageOption.Name + " - " + _Language.Name : Resources.CommonListManage.ResourceClassification;
            }
        ...
        #region Private Methods
            ...
            {
                Page.Title = Resources.CommonListManage.ResourceClassification_LG_Title;
                ...
                rfv1.ErrorMessage = Resources.Common.PageSubtitleProperties;
            }
            private void Add()
            {
