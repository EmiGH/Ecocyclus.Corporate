<%@ Page Language="C#" MasterPageFile="~/EMS.Master" AutoEventWireup="true" CodeBehind="ResourceTypesProperties.aspx.cs"
    Inherits="Condesus.EMS.WebUI.KC.ResourceTypesProperties" Title="EMS - Resource Type Property"
        ...
        <tr>
            <td>
                <table id="tblContentForm" runat="server" class="ContentForm">
                    ...
                    <tr>
                        <td class="ColTitle">
                            <asp:Label ID="lblParentResourceType" runat="server" Text="Parent Resource Type:" />
                        </td>
                        <td class="ColContent">
                            <asp:PlaceHolder ID="phParentResourceType" runat="server" />
                        </td>
