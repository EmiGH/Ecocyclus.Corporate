...
{
    public partial class ProcessTaskCalibrationsProperties : BasePropertiesTask
    {
        #region Internal Properties
            ...
            CompareValidator _CvMeasurementDevice;
            ...
            private ProcessTaskCalibration _Entity = null;
            private ProcessTaskCalibration Entity
            {
                get
                {
                    try
                    {
                        if (_Entity == null)
                            _Entity = (ProcessTaskCalibration)EMSLibrary.User.ProcessFramework.Map.Process(_IdProcessTaskCalibration);
            ...
            private Int64 _IdProcessTaskCalibration
            {
                get
                {
        ...
        #region PageLoad & Init
            protected override void InitializeHandlers()
            {
                ...
                rtsWizzardTask.OnClientTabSelecting = "onTabWizzardTaskCalibrationSelecting";
                rtsWizzardTask.OnClientLoad = "onTabWizzardTaskCalibrationLoad";
            ...
            protected override void OnInit(EventArgs e)
            {
                ...
                //base.AddTreeViewPosts(ref phPosts, ref _RtvPosts, new RadTreeViewEventHandler(rtvPosts_NodeExpand), new RadTreeViewEventHandler(rtvPosts_NodeCreated), new RadTreeViewEventHandler(rtvPosts_NodeCheck), cvTreeView, new ServerValidateEventHandler(cvTreeView_ServerValidate));
            ...
            protected override void OnLoad(EventArgs e)
            {
                ...
                base.InjectonTabWizzardTaskCalibrationSelecting(rfvOptionTypeExecution.ClientID, customvEndDate.ClientID, revDuration.ClientID, rfvDuration.ClientID, rfvInterval.ClientID, revInterval.ClientID, revNumberExec.ClientID, _CvTimeUnitDuration.ClientID, _CvTimeUnitInterval.ClientID, _CvMeasurementDeviceType.ClientID, _CvMeasurementDevice.ClientID, cvTreeView.ClientID);
                ...
                base.InjectonTabWizzardTaskCalibrationLoad(rfvOptionTypeExecution.ClientID, customvEndDate.ClientID, revDuration.ClientID, rfvDuration.ClientID, rfvInterval.ClientID, revInterval.ClientID, revNumberExec.ClientID, _CvTimeUnitDuration.ClientID, _CvTimeUnitInterval.ClientID, _CvMeasurementDeviceType.ClientID, _CvMeasurementDevice.ClientID, cvTreeView.ClientID);
                base.InjectEnableValidatorsCalibration();
                ...
                //base.InjectInitializeValidatorsOnTaskCalibration(_CvTimeUnitDuration.ClientID, _CvTimeUnitInterval.ClientID, _CvMeasurementDeviceType.ClientID, _CvMeasurementDevice.ClientID, customvEndDate.ClientID);
            ...
            protected override void SetPagetitle()
            {
                try
                {
                    base.PageTitle = (Entity != null) ? Entity.LanguageOption.Title : Resources.CommonListManage.ProcessTaskCalibration;
                }
        ...
        #region Private Methods
            ...
            {
                Page.Title = Resources.CommonListManage.ProcessTaskCalibration;
                ...
                rtsWizzardTask.Tabs[2].Text = Resources.CommonListManage.Calibration;
            ...
            private void AddValidators()
            {
                ...
                //ValidatorRequiredField(Common.ConstantsEntitiesName.PA.MeasurementDevices, phMeasurementDeviceValidator, ref _CvMeasurementDevice, _RdcMeasurementDevice, Resources.ConstantMessage.SelectAMeasurementDevice);

                //_CvMeasurementDeviceType.Style.Add("display", "none");
                //_CvMeasurementDeviceType.Attributes.Add("enabled", "false");
            }
            ...
            private void AddComboMeasurementDevices()
            {
                ...
                AddCombo(phMeasurementDevice, ref _RdcMeasurementDevice, Common.ConstantsEntitiesName.PA.MeasurementDevices, String.Empty, _params, false, true, false, true, false);
                _RdcMeasurementDevice.CausesValidation = true;
            ...
            {
                _RdcMeasurementDeviceType.SelectedValue = "IdMeasurementDeviceType=" + Entity.MeasurementDevice.DeviceType.IdMeasurementDeviceType.ToString();
            }
            private void SetMeasurementDevice()
            {
                _RdcMeasurementDevice.SelectedValue = "IdMeasurementDevice=" + Entity.MeasurementDevice.IdMeasurementDevice.ToString() + "& IdMeasurementDeviceType=" + Entity.MeasurementDevice.DeviceType.IdMeasurementDeviceType.ToString();
            }
        ...
        #region Page Events
            ...
            void _RdcMeasurementDeviceType_SelectedIndexChanged(object o, RadComboBoxSelectedIndexChangedEventArgs e)
            {
                AddComboMeasurementDevices();
            }
            ...
            protected void btnSave_Click(object sender, EventArgs e)
            {
                try
                {
                    ...
                    if (ValidatePostSelected())
                    {
                        ...
                        Int64 _idMeasurementDevice = Convert.ToInt64(GetKeyValue(_RdcMeasurementDevice.SelectedValue, "IdMeasurementDevice"));

                        Condesus.EMS.Business.PA.Entities.MeasurementDevice _measurementDevice = EMSLibrary.User.PerformanceAssessments.Configuration.MeasurementDeviceType(_idMeasurementDeviceType).MeasurementDevice(_idMeasurementDevice);
                        ...
                        if (!_wrongComboSelected)
                        {
                            ...
                            {
                                //Es un ADD
                                Entity = (Condesus.EMS.Business.PF.Entities.ProcessTaskCalibration)_processGroupProcess.ProcessTasksAdd(Convert.ToInt16(txtWeight.Text), base.SetProcessOrder(txtOrder.Text),
                                    ...
                                    Convert.ToInt32(txtInterval.Text), Convert.ToInt32(txtMaxNumberExecutions.Text), _result, Convert.ToInt32(txtCompleted.Text), _timeUnitDuration, _timeUnitInterval, _measurementDevice,
                                    _TypeExecution, _posts, _site, _taskInstruction, _notificationRecipients, _timeUnitNotification, _reminder);
                            }
                            else
                            {
                                //Es Modify
                                ...
                                //base.NavigatorAddTransferVar("IdParentProcess", _IdParentProcess);
                                //base.NavigatorAddTransferVar("IdTask", _IdProcessTaskCalibration);
                            ...
                            base.NavigatorAddTransferVar("EntityName", Common.ConstantsEntitiesName.PF.ProcessTaskCalibration);
                            ...
                            //Navigate("~/MainInfo/ListViewer.aspx", Resources.CommonListManage.ProcessTaskCalibration + " " + Entity.LanguageOption.Title, Condesus.WebUI.Navigation.DeleteType.DeleteModifiedEntity);
                            String _entityPropertyName = String.Concat(Entity.LanguageOption.Title);
                            NavigatePropertyEntity(Common.ConstantsEntitiesName.PF.ProcessTaskCalibration, _entityPropertyName, Condesus.WebUI.Navigation.NavigateMenuAction.Add);
            ...
            protected void btnNextPageView_Click(object sender, EventArgs e)
            {
                ...
                else
                {
                    ...
                    if (rpvScheduler.Selected)
                    {
                        ...
                        rpvCalibration.Selected = true;
                    }
                    else
                    {
                        //Si esta en el 3° se queda ahi...
                        if (rpvCalibration.Selected)
                        {
                            rtsWizzardTask.Tabs[2].Enabled = true;
                            rtsWizzardTask.Tabs[2].Selected = true;
            ...
            void lnkMeasurementDeviceType_Click(object sender, EventArgs e)
            {
                ...
                NavigatorAddTransferVar<String>("URL", _urlProperties);
                Navigate(_urlProperties, Common.ConstantsEntitiesName.PA.MeasurementDeviceType, true);
            }
            void lnkMeasurementDevice_Click(object sender, EventArgs e)
            {
                ...
                NavigatorAddTransferVar<String>("URL", _urlProperties);
                Navigate(_urlProperties, Common.ConstantsEntitiesName.PA.MeasurementDevice, true);
            }
        #endregion
