...
{
    public partial class ProcessClassificationsLanguagesProperties : BaseProperties
    {
        ...
        private Int64 _IdEntity
        {
            get
            {
                return base.NavigatorContainsTransferVar("IdProcessClassification") ? base.NavigatorGetTransferVar<Int64>("IdProcessClassification") : 0;
            }
        }
        ...
        private ProcessClassification_LG _EntityLanguage = null;
        private ProcessClassification_LG EntityLanguage
        {
            get
            {
        ...
        #region PageLoad & Init
            ...
            {
                base.PageTitle = (Entity != null) ? Entity.LanguageOption.Name + " - " + Global.Languages[_IdEntityLanguage].Name : Resources.CommonListManage.ProcessClassification;
            }
        ...
        #region Private Methods
            ...
            {
                Page.Title = Resources.CommonListManage.ProcessClassification_LG_Title;
