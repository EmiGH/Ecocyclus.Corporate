<%@ Page Language="C#" MasterPageFile="~/EMS.Master" MaintainScrollPositionOnPostback="true"
    AutoEventWireup="true" CodeBehind="ProcessTaskCalibrationsProperties.aspx.cs"
    Inherits="Condesus.EMS.WebUI.PM.ProcessTaskCalibrationsProperties" Title="EMS - Process Task Calibrations Properties"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentMain" runat="server">
    ...
    <rad:RadMultiPage ID="rmpWizzardTask" runat="server" SelectedIndex="0">
        <rad:RadPageView ID="rpvMainData" runat="server" Selected="true">
            <table id="tblContentForm" runat="server" class="ContentForm">
                ...
                <tr>
                    ...
                    <td class="ColContent">
                        <asp:TextBox ID="txtPurpose" runat="server" MaxLength="8000" Rows="6" SkinID="EMS"
                ...
                <tr>
                    ...
                    <td class="ColContent">
                        <asp:TextBox ID="txtDescription" MaxLength="8000" runat="server" SkinID="EMS" TextMode="MultiLine"
                            Rows="6"></asp:TextBox>
                    </td>
                    <td class="ColValidator">
                        &nbsp;
        ...
        <rad:RadPageView ID="rpvCalibration" runat="server" Selected="false">
            <table id="tblContentForm3" runat="server" class="ContentForm">
                ...
                <tr>
                    ...
                    <td class="ColValidator">
                        <asp:PlaceHolder ID="phMeasurementDeviceValidator" runat="server" />
                    </td>
                </tr>
            </table>
        </rad:RadPageView>
