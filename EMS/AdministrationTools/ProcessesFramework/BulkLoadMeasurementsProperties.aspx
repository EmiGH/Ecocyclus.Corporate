<%@ Page Language="C#" MasterPageFile="~/EMS.Master" AutoEventWireup="true" CodeBehind="BulkLoadMeasurementsProperties.aspx.cs"
    Inherits="Condesus.EMS.WebUI.PM.BulkLoadMeasurementsProperties" Title="EMS - Bulk Load Measurements Properties"
        ...
        <ContentTemplate>
            <asp:Panel runat="server" ID="contentHideFile" Style="margin-top: 10px">
                <table id="tblContentFormUploadFile" runat="server" class="ContentForm">
                    ...
                    <tr>
                        <td class="ColTitle">
                            <asp:Label ID="lblFile" runat="server" Text="Upload File Measurements:" />
                        </td>
                        <td class="ColContent">
