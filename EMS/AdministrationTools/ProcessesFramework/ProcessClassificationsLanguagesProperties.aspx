<%@ Page Language="C#" MasterPageFile="~/EMS.Master" AutoEventWireup="true" CodeBehind="ProcessClassificationsLanguagesProperties.aspx.cs"
    Inherits="Condesus.EMS.WebUI.PF.ProcessClassificationsLanguagesProperties" Title="EMS - Process Classification Language Option"
            ...
            <td>
                <table id="tblContentForm" runat="server" class="ContentForm">
                    ...
                    <tr>
                        ...
                        <td class="ColContent">
                            <asp:TextBox runat="server" SkinID="EMS" MaxLength="150" ID="txtName"></asp:TextBox>
                        </td>
