...
{
    public partial class ParticipationTypesLanguagesProperties : BaseProperties
    {
        ...
        private ParticipationType_LG _EntityLanguage = null;
        private ParticipationType_LG EntityLanguage
        {
            get
            {
        ...
        #region PageLoad & Init
            ...
            {
                base.PageTitle = (Entity != null) ? Entity.LanguageOption.Name + " - " + Global.Languages[_IdEntityLanguage].Name : Resources.CommonListManage.ParticipationType;
            }
        ...
        #region Private Methods
            ...
            {
                Page.Title = Resources.CommonListManage.ParticipationType_LG_Title;
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    //Alta
                    EntityLanguage = Entity.LanguagesOptions.Add(_IdEntityLanguage, txtName.Text);
                    
                }
                else
                {
                    //Modificacion
                    EntityLanguage = Entity.LanguagesOptions.Modify(_IdEntityLanguage, txtName.Text);
