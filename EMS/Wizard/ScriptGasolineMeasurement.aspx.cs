...
{
    public partial class ScriptGasolineMeasurement : BasePropertiesTask
    {
        ...
        #region Measurements
            ...
            private RadComboBox _RdcMeasurement_PCGasoline;
            private RadComboBox _RdcMeasurement_EFGasoline_CO2;
            private RadComboBox _RdcMeasurement_EFGasoline_CH4;
            private RadComboBox _RdcMeasurement_EFGasoline_N2O;
        #endregion
        ...
        #region PageLoad & Init
            ...
            protected override void OnLoad(EventArgs e)
            {
                ...
                AddComboMeasurement_PCGasoline();
                AddComboMeasurementFEGasoline_CO2();
                AddComboMeasurementFEGasoline_CH4();
                AddComboMeasurementFEGasoline_N2O();
        ...
        #region Private Methods
            ...
            {
                Int64 _idIndicatorGasoline = 17;
                Int64 _idNoConditionGasoline = 17;
            ...
            private void AddComboMeasurement_PCGasoline()
            {
                Dictionary<String, Object> _params = new Dictionary<String, Object>();
                if (_params.ContainsKey("IdProcess"))
                { _params.Remove("IdProcess"); }
                ...
                AddCombo(phMeasurementPCGasoline, ref _RdcMeasurement_PCGasoline, Common.ConstantsEntitiesName.PA.Measurements, String.Empty, _params, false, true, false, false, false);
            }
            private void AddComboMeasurementFEGasoline_CO2()
            {
                Dictionary<String, Object> _params = new Dictionary<String, Object>();
                if (_params.ContainsKey("IdProcess"))
                { _params.Remove("IdProcess"); }
                ...
                AddCombo(phMeasurementFEGasolineCO2, ref _RdcMeasurement_EFGasoline_CO2, Common.ConstantsEntitiesName.PA.Measurements, String.Empty, _params, false, true, false, false, false);
            }
            private void AddComboMeasurementFEGasoline_CH4()
            {
                Dictionary<String, Object> _params = new Dictionary<String, Object>();
                if (_params.ContainsKey("IdProcess"))
                { _params.Remove("IdProcess"); }
                ...
                AddCombo(phMeasurementFEGasolineCH4, ref _RdcMeasurement_EFGasoline_CH4, Common.ConstantsEntitiesName.PA.Measurements, String.Empty, _params, false, true, false, false, false);
            }
            private void AddComboMeasurementFEGasoline_N2O()
            {
                Dictionary<String, Object> _params = new Dictionary<String, Object>();
                if (_params.ContainsKey("IdProcess"))
                { _params.Remove("IdProcess"); }
                ...
                AddCombo(phMeasurementFEGasolineN2O, ref _RdcMeasurement_EFGasoline_N2O, Common.ConstantsEntitiesName.PA.Measurements, String.Empty, _params, false, true, false, false, false);
            }
            ...
            private Dictionary<String, Condesus.EMS.Business.IOperand> BuildOperatorForTransformation1(Int64 idMeasurement_PCGasoline, Int64 idMeasurement_EFGasoline_CO2)
            {
                Dictionary<String, Condesus.EMS.Business.IOperand> _operands = new Dictionary<String, Condesus.EMS.Business.IOperand>();

                Int64 _idConstantClass_DensidadGasoline = 7;
                Int64 _idConstant_DensidadGasoline = 8;
                ...
                _operands.Add("B", EMSLibrary.User.PerformanceAssessments.Configuration.Measurement(idMeasurement_PCGasoline));
                _operands.Add("C", EMSLibrary.User.PerformanceAssessments.Configuration.Measurement(idMeasurement_EFGasoline_CO2));
            ...
            private Dictionary<String, Condesus.EMS.Business.IOperand> BuildOperatorForTransformation4(Int64 idMeasurement_PCGasoline, Int64 idMeasurement_EFGasoline_CH4)
            {
                Dictionary<String, Condesus.EMS.Business.IOperand> _operands = new Dictionary<String, Condesus.EMS.Business.IOperand>();
                ...
                _operands.Add("A", EMSLibrary.User.PerformanceAssessments.Configuration.ConstantClassification(_idConstantClass_DensidadGasoline).Constant(_idConstant_DensidadGasoline));
                _operands.Add("B", EMSLibrary.User.PerformanceAssessments.Configuration.Measurement(idMeasurement_PCGasoline));
                _operands.Add("C", EMSLibrary.User.PerformanceAssessments.Configuration.Measurement(idMeasurement_EFGasoline_CH4));
            ...
            private Dictionary<String, Condesus.EMS.Business.IOperand> BuildOperatorForTransformation7(Int64 idMeasurement_PCGasoline, Int64 idMeasurement_EFGasoline_N2O)
            {
                Dictionary<String, Condesus.EMS.Business.IOperand> _operands = new Dictionary<String, Condesus.EMS.Business.IOperand>();
                ...
                _operands.Add("A", EMSLibrary.User.PerformanceAssessments.Configuration.ConstantClassification(_idConstantClass_DensidadGasoline).Constant(_idConstant_DensidadGasoline));
                _operands.Add("B", EMSLibrary.User.PerformanceAssessments.Configuration.Measurement(idMeasurement_PCGasoline));
                _operands.Add("C", EMSLibrary.User.PerformanceAssessments.Configuration.Measurement(idMeasurement_EFGasoline_N2O));
                    ...
                    using (TransactionScope _transactionScope = new TransactionScope(new TransactionScopeOption(), new TimeSpan(0, 10, 0)))
                    {
                        ...
                        foreach (String _item in _SitesAux)
                        {
                            ...
                            CalculateOfTransformation _calculateOfTransformation_1 = TransformationAdd(_idIndicatorCO2, _idMeasurementUnit_ton,
                                _taskMeasurementBase.Measurement, null, BuildOperatorForTransformation1(_idMeasurement_PCGasoline, _idMeasurement_EFGasoline_CO2), _transformationName, txtDescription.Text, "Base*A/1000000*B*C");
                            #endregion
                            ...
                            CalculateOfTransformation _calculateOfTransformation_4 = TransformationAdd(_idIndicatorCH4, _idMeasurementUnit_ton,
                                _taskMeasurementBase.Measurement, null, BuildOperatorForTransformation4(_idMeasurement_PCGasoline, _idMeasurement_EFGasoline_CH4), _transformationName, txtDescription.Text, "Base*A/1000000*B*C");
                            #endregion
                            ...
                            CalculateOfTransformation _calculateOfTransformation_7 = TransformationAdd(_idIndicatorN2O, _idMeasurementUnit_ton,
                                _taskMeasurementBase.Measurement, null, BuildOperatorForTransformation7(_idMeasurement_PCGasoline, _idMeasurement_EFGasoline_N2O), _transformationName, txtDescription.Text, "Base*A*B*C");
                            #endregion
