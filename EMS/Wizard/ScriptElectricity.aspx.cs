...
{
    public partial class ScriptElectricity : BasePropertiesTask
    {
        #region Internal Properties
            ...
            #region Measurements
                private RadComboBox _RdcMeasurement_EFRed;
            #endregion
        ...
        #region PageLoad & Init
            ...
            protected override void OnLoad(EventArgs e)
            {
                ...
                AddComboMeasurementFactorEmisionRed();
        ...
        #region Private Methods
            ...
            {
                Int64 _idIndicatorElectricity = 18;                     //18->Electricity
                Int64 _idNoConditionElectricity = 18;                   //18->No Condition	S/D
            ...
            private void AddComboMeasurementFactorEmisionRed()
            {
                Dictionary<String, Object> _params = new Dictionary<String, Object>();
                ...
                AddCombo(phMeasurement2, ref _RdcMeasurement_EFRed, Common.ConstantsEntitiesName.PA.Measurements, String.Empty, _params, false, true, false, false, false);
            }
            ...
            #region Transformation Add
                ...
                private Dictionary<String, Condesus.EMS.Business.IOperand> BuildOperatorForTransformation(Int64 idMeasurement_EFRed)
                {
                    Dictionary<String, Condesus.EMS.Business.IOperand> _operands = new Dictionary<String, Condesus.EMS.Business.IOperand>();

                    _operands.Add("A", EMSLibrary.User.PerformanceAssessments.Configuration.Measurement(idMeasurement_EFRed));
                ...
                try
                {
                    ...
                    using (TransactionScope _transactionScope = new TransactionScope(new TransactionScopeOption(), new TimeSpan(0, 10, 0)))
                    {
                        ...
                        foreach (String _item in _SitesAux)
                        {
                            ...
                            Int64 _idIndicatorCO2e = 22;     //1->CO__2e__	CO__2__e
                            ...
                            #region   b- Alta de Transformacion Hija de Medicion Base:
                                ...
                                CalculateOfTransformation _calculateOfTransformation_1 = TransformationAdd(_idIndicatorCO2e, _idMeasurementUnitTon,
                                    _taskMeasurementBase.Measurement, null, BuildOperatorForTransformation(_idMeasurement_EFRed), _transformationName, txtDescription.Text, "Base/1000*A");
                            #endregion
