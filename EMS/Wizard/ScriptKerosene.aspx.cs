...
{
    public partial class ScriptKerosene : BasePropertiesTask
    {
        ...
        {
            Int64 _idIndicatorKerosene = 16;
            Int64 _idNoConditionKerosene = 16;
            Int64 _idMagnitud = 42;                                  //42->Volumen
            Int64 _idMeasurementUnit_m3 = 120;                      //120->m3	Cubic Meter

            Indicator _indicator = EMSLibrary.User.PerformanceAssessments.Map.Indicator(_idIndicatorKerosene);

            lblIndicatorValue.Text = Common.Functions.ReplaceIndexesTags(_indicator.LanguageOption.Name);
            lblParameterGroupValue.Text = _indicator.ParameterGroup(_idNoConditionKerosene).LanguageOption.Name;
            ...
            try
            {
                ...
                using (TransactionScope _transactionScope = new TransactionScope(new TransactionScopeOption(), new TimeSpan(0, 10, 0)))
                {
                    ...
                    foreach (String _item in _SitesAux)
                    {
                        ...
                        ProcessTaskMeasurement _taskMeasurementBase = MeasurementTaskAdd(true, _site, _idIndicatorKerosene, _idNoConditionKerosene, _idMeasurementUnit_m3, _measurementTaskBaseName, txtDescription.Text);
                        #endregion
