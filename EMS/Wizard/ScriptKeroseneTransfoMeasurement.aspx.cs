...
{
    public partial class ScriptKeroseneTransfoMeasurement : BasePropertiesTask
    {
                ...
                try
                {
                    ...
                    using (TransactionScope _transactionScope = new TransactionScope(new TransactionScopeOption(), new TimeSpan(0, 10, 0)))
                    {
                        ...
                        CalculateOfTransformation _calculateOfTransformation_1 = TransformationAdd(_idIndicatorCO2, _idMeasurementUnit_ton,
                            null, _calcultaeOfTransformationBase, BuildOperatorForTransformation1(_idMeasurement_PCKerosene, _idMeasurement_EFKerosene_CO2), _transformationName, String.Empty, "Base*A/1000000*B*C");
                        #endregion
                        ...
                        CalculateOfTransformation _calculateOfTransformation_4 = TransformationAdd(_idIndicatorCH4, _idMeasurementUnit_ton,
                            null, _calcultaeOfTransformationBase, BuildOperatorForTransformation4(_idMeasurement_PCKerosene, _idMeasurement_EFKerosene_CH4), _transformationName, String.Empty, "Base*A/1000000*B*C");
                        #endregion
                        ...
                        CalculateOfTransformation _calculateOfTransformation_7 = TransformationAdd(_idIndicatorN2O, _idMeasurementUnit_ton,
                            null, _calcultaeOfTransformationBase, BuildOperatorForTransformation7(_idMeasurement_PCKerosene, _idMeasurement_EFKerosene_N2O), _transformationName, String.Empty, "Base*A*B*C");
                        #endregion
