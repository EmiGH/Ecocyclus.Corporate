...
{
    public partial class ScriptNaturalGas : BasePropertiesTask
    {
        #region Internal Properties
            ...
            #region Constants
                private RadComboBox _RdcConst_DesidadNaturalGas;
                private RadTreeView _RtvConstant_DesidadNaturalGas;
                ...
                private RadComboBox _RdcConst_PCNaturalGas;
                private RadTreeView _RtvConstant_PCNaturalGas;
                private RadComboBox _RdcConst_EFNaturalGas_CO2;
                private RadTreeView _RtvConstant_EFNaturalGas_CO2;
                private RadComboBox _RdcConst_EFNaturalGas_CH4;
                private RadTreeView _RtvConstant_EFNaturalGas_CH4;
                private RadComboBox _RdcConst_EFNaturalGas_N2O;
                private RadTreeView _RtvConstant_EFNaturalGas_N2O;
            #endregion
        ...
        #region PageLoad & Init
            ...
            protected override void OnLoad(EventArgs e)
            {
                ...
                AddComboConst_DesidadNaturalGas();
                AddComboConst_PCG_CH4();
                AddComboConst_PCG_N2O();

                AddComboConst_PCNaturalGas();
                AddComboConstFENaturalGas_CO2();
                AddComboConstFENaturalGas_CH4();
                AddComboConstFENaturalGas_N2O();
            ...
            {
                base.PageTitle = Resources.CommonListManage.ScriptNaturalGas;
            }
        ...
        #region Private Methods
            ...
            {
                Int64 _idIndicatorNaturalGas = 289;//Para Demo  // 15;//Para Ghree
                Int64 _idNoConditionNaturalGas = 247;//Para Demo // 15;//Para Ghree
                Int64 _idMagnitud = 42;                                  //42->Volumen
                Int64 _idMeasurementUnit_m3 = 120;                      //120->m3	Cubic Meter

                Indicator _indicator = EMSLibrary.User.PerformanceAssessments.Map.Indicator(_idIndicatorNaturalGas);

                lblIndicatorValue.Text = Common.Functions.ReplaceIndexesTags(_indicator.LanguageOption.Name);
                lblParameterGroupValue.Text = _indicator.ParameterGroup(_idNoConditionNaturalGas).LanguageOption.Name;
            ...
            {
                Page.Title = Resources.CommonListManage.ScriptNaturalGas;
            ...
            private void AddComboConst_DesidadNaturalGas()
            {
                Dictionary<String, Object> _params = new Dictionary<String, Object>();
                AddComboTreeConstant(ref phConstDesidadNaturalGas, ref _RdcConst_DesidadNaturalGas, ref _RtvConstant_DesidadNaturalGas, new RadTreeViewEventHandler(rtvConst_NodeExpand));
            }
            ...
            private void AddComboConst_PCNaturalGas()
            {
                Dictionary<String, Object> _params = new Dictionary<String, Object>();
                AddComboTreeConstant(ref phConstPCNaturalGas, ref _RdcConst_PCNaturalGas, ref _RtvConstant_PCNaturalGas, new RadTreeViewEventHandler(rtvConst_NodeExpand));
            }
            private void AddComboConstFENaturalGas_CO2()
            {
                Dictionary<String, Object> _params = new Dictionary<String, Object>();
                AddComboTreeConstant(ref phConstFENaturalGasCO2, ref _RdcConst_EFNaturalGas_CO2, ref _RtvConstant_EFNaturalGas_CO2, new RadTreeViewEventHandler(rtvConst_NodeExpand));
            }
            private void AddComboConstFENaturalGas_CH4()
            {
                Dictionary<String, Object> _params = new Dictionary<String, Object>();
                AddComboTreeConstant(ref phConstFENaturalGasCH4, ref _RdcConst_EFNaturalGas_CH4, ref _RtvConstant_EFNaturalGas_CH4, new RadTreeViewEventHandler(rtvConst_NodeExpand));
            }
            private void AddComboConstFENaturalGas_N2O()
            {
                Dictionary<String, Object> _params = new Dictionary<String, Object>();
                AddComboTreeConstant(ref phConstFENaturalGasN2O, ref _RdcConst_EFNaturalGas_N2O, ref _RtvConstant_EFNaturalGas_N2O, new RadTreeViewEventHandler(rtvConst_NodeExpand));
            }
            ...
            #region Transformation Add
                ...
                private Dictionary<String, Condesus.EMS.Business.IOperand> BuildOperatorForTransformation1()
                {
                    ...
                    Int64 _idConstantClass_EFNaturalGas_CH4 = Convert.ToInt64(GetKeyValue(_RtvConstant_EFNaturalGas_CH4.SelectedNode.Value, "IdConstantClassification"));
                    Int64 _idConstantClass_EFNaturalGas_N2O = Convert.ToInt64(GetKeyValue(_RtvConstant_EFNaturalGas_N2O.SelectedNode.Value, "IdConstantClassification"));
                    Int64 _idConstantClass_EFNaturalGas_CO2 = Convert.ToInt64(GetKeyValue(_RtvConstant_EFNaturalGas_CO2.SelectedNode.Value, "IdConstantClassification"));
                    Int64 _idConstantClass_PCNaturalGas = Convert.ToInt64(GetKeyValue(_RtvConstant_PCNaturalGas.SelectedNode.Value, "IdConstantClassification"));

                    Int64 _idConstant_EFNaturalGas_CH4 = Convert.ToInt64(GetKeyValue(_RtvConstant_EFNaturalGas_CH4.SelectedNode.Value, "IdConstant"));
                    Int64 _idConstant_EFNaturalGas_N2O = Convert.ToInt64(GetKeyValue(_RtvConstant_EFNaturalGas_N2O.SelectedNode.Value, "IdConstant"));
                    Int64 _idConstant_EFNaturalGas_CO2 = Convert.ToInt64(GetKeyValue(_RtvConstant_EFNaturalGas_CO2.SelectedNode.Value, "IdConstant"));
                    Int64 _idConstant_PCNaturalGas = Convert.ToInt64(GetKeyValue(_RtvConstant_PCNaturalGas.SelectedNode.Value, "IdConstant"));

                    Int64 _idConstantClass_DensidadNaturalGas = Convert.ToInt64(GetKeyValue(_RtvConstant_DesidadNaturalGas.SelectedNode.Value, "IdConstantClassification"));
                    Int64 _idConstant_DensidadNaturalGas = Convert.ToInt64(GetKeyValue(_RtvConstant_DesidadNaturalGas.SelectedNode.Value, "IdConstant")); ;

                    _operands.Add("A", EMSLibrary.User.PerformanceAssessments.Configuration.ConstantClassification(_idConstantClass_DensidadNaturalGas).Constant(_idConstant_DensidadNaturalGas));
                    _operands.Add("B", EMSLibrary.User.PerformanceAssessments.Configuration.ConstantClassification(_idConstantClass_PCNaturalGas).Constant(_idConstant_PCNaturalGas));
                    _operands.Add("C", EMSLibrary.User.PerformanceAssessments.Configuration.ConstantClassification(_idConstantClass_EFNaturalGas_CO2).Constant(_idConstant_EFNaturalGas_CO2));
                ...
                private Dictionary<String, Condesus.EMS.Business.IOperand> BuildOperatorForTransformation4()
                {
                    ...
                    _operands.Add("A", EMSLibrary.User.PerformanceAssessments.Configuration.ConstantClassification(_idConstantClass_DensidadNaturalGas).Constant(_idConstant_DensidadNaturalGas));
                    _operands.Add("B", EMSLibrary.User.PerformanceAssessments.Configuration.ConstantClassification(_idConstantClass_PCNaturalGas).Constant(_idConstant_PCNaturalGas));
                    _operands.Add("C", EMSLibrary.User.PerformanceAssessments.Configuration.ConstantClassification(_idConstantClass_EFNaturalGas_CH4).Constant(_idConstant_EFNaturalGas_CH4));
                ...
                private Dictionary<String, Condesus.EMS.Business.IOperand> BuildOperatorForTransformation7()
                {
                    ...
                    _operands.Add("A", EMSLibrary.User.PerformanceAssessments.Configuration.ConstantClassification(_idConstantClass_DensidadNaturalGas).Constant(_idConstant_DensidadNaturalGas));
                    _operands.Add("B", EMSLibrary.User.PerformanceAssessments.Configuration.ConstantClassification(_idConstantClass_PCNaturalGas).Constant(_idConstant_PCNaturalGas));
                    _operands.Add("C", EMSLibrary.User.PerformanceAssessments.Configuration.ConstantClassification(_idConstantClass_EFNaturalGas_N2O).Constant(_idConstant_EFNaturalGas_N2O));
        ...
        #region Page Events
            ...
            protected void btnSave_Click(object sender, EventArgs e)
            {
                try
                {
                    Int64 _idIndicatorCH4 = 32;//Para Demo  // 2;//Para Ghree
                    Int64 _idIndicatorN2O = 33;//Para Demo  // 3;//Para Ghree
                    Int64 _idIndicatorCO2 = 31;//Para Demo  // 1;//Para Ghree
                    Int64 _idIndicatorCO2eFromCH4 = 68;//Para Demo  // 7;//Para Ghree
                    Int64 _idIndicatorCO2eFromN2O = 70;//Para Demo // 9;//Para Ghree
                    Int64 _idIndicatorCO2eFromCO2 = 67;//Para Demo// 8;//Para Ghree
                    Int64 _idIndicatorCO2e = 37;//Para Demo //22; //Para Ghree
                    ...
                    using (TransactionScope _transactionScope = new TransactionScope(new TransactionScopeOption(), new TimeSpan(0, 10, 0)))
                    {
                        ...
                        foreach (String _item in _SitesAux)
                        {
                            ...
                            #region Tarea Medicion BASE
                                ...
                                ProcessTaskMeasurement _taskMeasurementBase = MeasurementTaskAdd(true, _site, _idIndicatorNaturalGas, _idNoConditionNaturalGas, _idMeasurementUnit_m3, _measurementTaskBaseName, txtDescription.Text);
                            #endregion
                            ...
                            #region   1- Alta de Transformacion Hija de Medicion Base:
                                ...
                                CalculateOfTransformation _calculateOfTransformation_1 = TransformationAdd(_idIndicatorCO2, _idMeasurementUnit_ton,
                                    _taskMeasurementBase.Measurement, null, BuildOperatorForTransformation1(), _transformationName, txtDescription.Text, "Base*A/1000000*B*C");
                            #endregion
                            ...
                            #region   4- Transformacion 4 hija de Medicion Base:
                                ...
                                CalculateOfTransformation _calculateOfTransformation_4 = TransformationAdd(_idIndicatorCH4, _idMeasurementUnit_ton,
                                    _taskMeasurementBase.Measurement, null, BuildOperatorForTransformation4(), _transformationName, txtDescription.Text, "Base*A/1000000*B*C");
                            #endregion
                            ...
                            #region   7- Transformacion 7 hija de Medición Base:
                                ...
                                CalculateOfTransformation _calculateOfTransformation_7 = TransformationAdd(_idIndicatorN2O, _idMeasurementUnit_ton,
                                    _taskMeasurementBase.Measurement, null, BuildOperatorForTransformation7(), _transformationName, txtDescription.Text, "Base*A*B*C");
                            #endregion
