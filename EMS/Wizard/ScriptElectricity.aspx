<%@ Page Title="" Language="C#" MasterPageFile="~/EMS.Master" AutoEventWireup="true" CodeBehind="ScriptElectricity.aspx.cs" 
Inherits="Condesus.EMS.WebUI.Wizard.ScriptElectricity" %>
        ...
        <tr>
            <td>
                <table id="tblContentForm" runat="server" class="ContentForm">
                    ...
                    <!-- SELECCION DE 1 MEDICION que es el factor de emision de la Red!!! -->
                    ...
                    <tr>
                        ...
                        <td class="ColContent">
                            <asp:UpdatePanel ID="upMeasurement" runat="server" UpdateMode="Always">
                                <ContentTemplate>
                                    <asp:PlaceHolder ID="phMeasurement2" runat="server" />
                                </ContentTemplate>
                            </asp:UpdatePanel>
                        </td>
                        <td class="ColValidator">
