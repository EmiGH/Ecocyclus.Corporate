<%@ Page Title="" Language="C#" MasterPageFile="~/EMS.Master" AutoEventWireup="true" CodeBehind="ScriptDieselMeasurement.aspx.cs" 
Inherits="Condesus.EMS.WebUI.Wizard.ScriptDieselMeasurement" %>
        ...
        <tr>
            <td>
                <table id="tblContentForm" runat="server" class="ContentForm">
                    ...
                    <!-- Medición 18. Poder Calorifico del Diesel -->
                    <tr>
                        <td class="ColTitle">
                            <asp:Label ID="lblMeasurementPCDiesel" runat="server" Text="Poder Calorifico del Diesel:" />
                        </td>
                        <td class="ColContent">
                            <asp:UpdatePanel ID="upMeasurementPCDiesel" runat="server" UpdateMode="Always">
                                <ContentTemplate>
                                    <asp:PlaceHolder ID="phMeasurementPCDiesel" runat="server" />
                                </ContentTemplate>
                            </asp:UpdatePanel>
                        </td>
                        <td class="ColValidator">
                    ...
                    <!-- Medición 19. Factor de Emision del Diesel para CO2 -->
                    <tr>
                        <td class="ColTitle">
                            <asp:Label ID="lblMeasurementFEDieselCO2" runat="server" Text="Factor de Emision del Diesel para CO2:" />
                        </td>
                        <td class="ColContent">
                            <asp:UpdatePanel ID="upMeasurementFEDieselCO2" runat="server" UpdateMode="Always">
                                <ContentTemplate>
                                    <asp:PlaceHolder ID="phMeasurementFEDieselCO2" runat="server" />
                                </ContentTemplate>
                            </asp:UpdatePanel>
                        </td>
                        <td class="ColValidator">
                    ...
                    <!-- Medición 20. Factor de Emision del Diesel para CH4 -->
                    <tr>
                        <td class="ColTitle">
                            <asp:Label ID="lblMeasurementFEDieselCH4" runat="server" Text="Factor de Emision del Diesel para CH4:" />
                        </td>
                        <td class="ColContent">
                            <asp:UpdatePanel ID="upMeasurementFEDieselCH4" runat="server" UpdateMode="Always">
                                <ContentTemplate>
                                    <asp:PlaceHolder ID="phMeasurementFEDieselCH4" runat="server" />
                                </ContentTemplate>
                            </asp:UpdatePanel>
                        </td>
                        <td class="ColValidator">
                    ...
                    <!-- Medición 21. Factor de Emision del Diesel para N2O -->
                    <tr>
                        <td class="ColTitle">
                            <asp:Label ID="lblMeasurementFEDieselN2O" runat="server" Text="Factor de Emision del Diesel para N2O:" />
                        </td>
                        <td class="ColContent">
                            <asp:UpdatePanel ID="upMeasurementFEDieselN2O" runat="server" UpdateMode="Always">
                                <ContentTemplate>
                                    <asp:PlaceHolder ID="phMeasurementFEDieselN2O" runat="server" />
                                </ContentTemplate>
                            </asp:UpdatePanel>
                        </td>
                        <td class="ColValidator">
