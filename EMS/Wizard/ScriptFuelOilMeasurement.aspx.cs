...
{
    public partial class ScriptFuelOilMeasurement : BasePropertiesTask
    {
        ...
        #region Measurements
            ...
            private RadComboBox _RdcMeasurement_PCFuelOil;
            private RadComboBox _RdcMeasurement_EFFuelOil_CO2;
            private RadComboBox _RdcMeasurement_EFFuelOil_CH4;
            private RadComboBox _RdcMeasurement_EFFuelOil_N2O;
        #endregion
        ...
        #region PageLoad & Init
            ...
            protected override void OnLoad(EventArgs e)
            {
                ...
                AddComboMeasurement_PCFuelOil();
                AddComboMeasurementFEFuelOil_CO2();
                AddComboMeasurementFEFuelOil_CH4();
                AddComboMeasurementFEFuelOil_N2O();
        ...
        #region Private Methods
            ...
            {
                Int64 _idIndicatorFuelOil = 14;
                Int64 _idNoConditionFuelOil = 14;
                Int64 _idMagnitud = 42;                                  //42->Volumen
                Int64 _idMeasurementUnit_m3 = 120;                      //120->m3	Cubic Meter

                Indicator _indicator = EMSLibrary.User.PerformanceAssessments.Map.Indicator(_idIndicatorFuelOil);

                lblIndicatorValue.Text = Common.Functions.ReplaceIndexesTags(_indicator.LanguageOption.Name);
                lblParameterGroupValue.Text = _indicator.ParameterGroup(_idNoConditionFuelOil).LanguageOption.Name;
            ...
            private void AddComboMeasurement_PCFuelOil()
            {
                Dictionary<String, Object> _params = new Dictionary<String, Object>();
                if (_params.ContainsKey("IdProcess"))
                { _params.Remove("IdProcess"); }
                ...
                AddCombo(phMeasurementPCFuelOil, ref _RdcMeasurement_PCFuelOil, Common.ConstantsEntitiesName.PA.Measurements, String.Empty, _params, false, true, false, false, false);
            }
            private void AddComboMeasurementFEFuelOil_CO2()
            {
                Dictionary<String, Object> _params = new Dictionary<String, Object>();
                if (_params.ContainsKey("IdProcess"))
                { _params.Remove("IdProcess"); }
                ...
                AddCombo(phMeasurementFEFuelOilCO2, ref _RdcMeasurement_EFFuelOil_CO2, Common.ConstantsEntitiesName.PA.Measurements, String.Empty, _params, false, true, false, false, false);
            }
            private void AddComboMeasurementFEFuelOil_CH4()
            {
                Dictionary<String, Object> _params = new Dictionary<String, Object>();
                if (_params.ContainsKey("IdProcess"))
                { _params.Remove("IdProcess"); }
                ...
                AddCombo(phMeasurementFEFuelOilCH4, ref _RdcMeasurement_EFFuelOil_CH4, Common.ConstantsEntitiesName.PA.Measurements, String.Empty, _params, false, true, false, false, false);
            }
            private void AddComboMeasurementFEFuelOil_N2O()
            {
                Dictionary<String, Object> _params = new Dictionary<String, Object>();
                if (_params.ContainsKey("IdProcess"))
                { _params.Remove("IdProcess"); }
                ...
                AddCombo(phMeasurementFEFuelOilN2O, ref _RdcMeasurement_EFFuelOil_N2O, Common.ConstantsEntitiesName.PA.Measurements, String.Empty, _params, false, true, false, false, false);
            }
            ...
            private Dictionary<String, Condesus.EMS.Business.IOperand> BuildOperatorForTransformation1(Int64 idMeasurement_PCFuelOil, Int64 idMeasurement_EFFuelOil_CO2)
            {
                Dictionary<String, Condesus.EMS.Business.IOperand> _operands = new Dictionary<String, Condesus.EMS.Business.IOperand>();

                Int64 _idConstantClass_DensidadFuelOil = 7;
                Int64 _idConstant_DensidadFuelOil = 11;
                ...
                _operands.Add("B", EMSLibrary.User.PerformanceAssessments.Configuration.Measurement(idMeasurement_PCFuelOil));
                _operands.Add("C", EMSLibrary.User.PerformanceAssessments.Configuration.Measurement(idMeasurement_EFFuelOil_CO2));
            ...
            private Dictionary<String, Condesus.EMS.Business.IOperand> BuildOperatorForTransformation4(Int64 idMeasurement_PCFuelOil, Int64 idMeasurement_EFFuelOil_CH4)
            {
                Dictionary<String, Condesus.EMS.Business.IOperand> _operands = new Dictionary<String, Condesus.EMS.Business.IOperand>();
                ...
                _operands.Add("A", EMSLibrary.User.PerformanceAssessments.Configuration.ConstantClassification(_idConstantClass_DensidadFuelOil).Constant(_idConstant_DensidadFuelOil));
                _operands.Add("B", EMSLibrary.User.PerformanceAssessments.Configuration.Measurement(idMeasurement_PCFuelOil));
                _operands.Add("C", EMSLibrary.User.PerformanceAssessments.Configuration.Measurement(idMeasurement_EFFuelOil_CH4));
            ...
            private Dictionary<String, Condesus.EMS.Business.IOperand> BuildOperatorForTransformation7(Int64 idMeasurement_PCFuelOil, Int64 idMeasurement_EFFuelOil_N2O)
            {
                Dictionary<String, Condesus.EMS.Business.IOperand> _operands = new Dictionary<String, Condesus.EMS.Business.IOperand>();
                ...
                _operands.Add("A", EMSLibrary.User.PerformanceAssessments.Configuration.ConstantClassification(_idConstantClass_DensidadFuelOil).Constant(_idConstant_DensidadFuelOil));
                _operands.Add("B", EMSLibrary.User.PerformanceAssessments.Configuration.Measurement(idMeasurement_PCFuelOil));
                _operands.Add("C", EMSLibrary.User.PerformanceAssessments.Configuration.Measurement(idMeasurement_EFFuelOil_N2O));
                ...
                try
                {
                    ...
                    using (TransactionScope _transactionScope = new TransactionScope(new TransactionScopeOption(), new TimeSpan(0, 10, 0)))
                    {
                        ...
                        foreach (String _item in _SitesAux)
                        {
                            ...
                            ProcessTaskMeasurement _taskMeasurementBase = MeasurementTaskAdd(true, _site, _idIndicatorFuelOil, _idNoConditionFuelOil, _idMeasurementUnit_m3, _measurementTaskBaseName, txtDescription.Text);
                            #endregion
                            ...
                            CalculateOfTransformation _calculateOfTransformation_1 = TransformationAdd(_idIndicatorCO2, _idMeasurementUnit_ton,
                                _taskMeasurementBase.Measurement, null, BuildOperatorForTransformation1(_idMeasurement_PCFuelOil, _idMeasurement_EFFuelOil_CO2), _transformationName, txtDescription.Text, "Base*A/1000000*B*C");
                            #endregion
                            ...
                            CalculateOfTransformation _calculateOfTransformation_4 = TransformationAdd(_idIndicatorCH4, _idMeasurementUnit_ton,
                                _taskMeasurementBase.Measurement, null, BuildOperatorForTransformation4(_idMeasurement_PCFuelOil, _idMeasurement_EFFuelOil_CH4), _transformationName, txtDescription.Text, "Base*A/1000000*B*C");
                            #endregion
                            ...
                            CalculateOfTransformation _calculateOfTransformation_7 = TransformationAdd(_idIndicatorN2O, _idMeasurementUnit_ton,
                                _taskMeasurementBase.Measurement, null, BuildOperatorForTransformation7(_idMeasurement_PCFuelOil, _idMeasurement_EFFuelOil_N2O), _transformationName, txtDescription.Text, "Base*A*B*C");
                            #endregion
