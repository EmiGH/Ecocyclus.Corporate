...
{
    public partial class ScriptNaturalGasMeasurement : BasePropertiesTask
    {
        ...
        #region Measurements
            ...
            private RadComboBox _RdcMeasurement_PCNaturalGas;
            private RadComboBox _RdcMeasurement_EFNaturalGas_CO2;
            private RadComboBox _RdcMeasurement_EFNaturalGas_CH4;
            private RadComboBox _RdcMeasurement_EFNaturalGas_N2O;
        #endregion
        ...
        #region PageLoad & Init
            ...
            protected override void OnLoad(EventArgs e)
            {
                ...
                AddComboMeasurement_PCNaturalGas();
                AddComboMeasurementFENaturalGas_CO2();
                AddComboMeasurementFENaturalGas_CH4();
                AddComboMeasurementFENaturalGas_N2O();
        ...
        #region Private Methods
            ...
            {
                Int64 _idIndicatorNaturalGas = 15;
                Int64 _idNoConditionNaturalGas = 15;
            ...
            private void AddComboMeasurement_PCNaturalGas()
            {
                Dictionary<String, Object> _params = new Dictionary<String, Object>();
                if (_params.ContainsKey("IdProcess"))
                { _params.Remove("IdProcess"); }
                ...
                AddCombo(phMeasurementPCNaturalGas, ref _RdcMeasurement_PCNaturalGas, Common.ConstantsEntitiesName.PA.Measurements, String.Empty, _params, false, true, false, false, false);
            }
            private void AddComboMeasurementFENaturalGas_CO2()
            {
                Dictionary<String, Object> _params = new Dictionary<String, Object>();
                if (_params.ContainsKey("IdProcess"))
                { _params.Remove("IdProcess"); }
                ...
                AddCombo(phMeasurementFENaturalGasCO2, ref _RdcMeasurement_EFNaturalGas_CO2, Common.ConstantsEntitiesName.PA.Measurements, String.Empty, _params, false, true, false, false, false);
            }
            private void AddComboMeasurementFENaturalGas_CH4()
            {
                Dictionary<String, Object> _params = new Dictionary<String, Object>();
                if (_params.ContainsKey("IdProcess"))
                { _params.Remove("IdProcess"); }
                ...
                AddCombo(phMeasurementFENaturalGasCH4, ref _RdcMeasurement_EFNaturalGas_CH4, Common.ConstantsEntitiesName.PA.Measurements, String.Empty, _params, false, true, false, false, false);
            }
            private void AddComboMeasurementFENaturalGas_N2O()
            {
                Dictionary<String, Object> _params = new Dictionary<String, Object>();
                if (_params.ContainsKey("IdProcess"))
                { _params.Remove("IdProcess"); }
                ...
                AddCombo(phMeasurementFENaturalGasN2O, ref _RdcMeasurement_EFNaturalGas_N2O, Common.ConstantsEntitiesName.PA.Measurements, String.Empty, _params, false, true, false, false, false);
            }
            ...
            private Dictionary<String, Condesus.EMS.Business.IOperand> BuildOperatorForTransformation1(Int64 idMeasurement_PCNaturalGas, Int64 idMeasurement_EFNaturalGas_CO2)
            {
                Dictionary<String, Condesus.EMS.Business.IOperand> _operands = new Dictionary<String, Condesus.EMS.Business.IOperand>();

                Int64 _idConstantClass_DensidadNaturalGas = 7;
                Int64 _idConstant_DensidadNaturalGas = 7;
                ...
                _operands.Add("B", EMSLibrary.User.PerformanceAssessments.Configuration.Measurement(idMeasurement_PCNaturalGas));
                _operands.Add("C", EMSLibrary.User.PerformanceAssessments.Configuration.Measurement(idMeasurement_EFNaturalGas_CO2));
            ...
            private Dictionary<String, Condesus.EMS.Business.IOperand> BuildOperatorForTransformation4(Int64 idMeasurement_PCNaturalGas, Int64 idMeasurement_EFNaturalGas_CH4)
            {
                Dictionary<String, Condesus.EMS.Business.IOperand> _operands = new Dictionary<String, Condesus.EMS.Business.IOperand>();
                ...
                _operands.Add("A", EMSLibrary.User.PerformanceAssessments.Configuration.ConstantClassification(_idConstantClass_DensidadNaturalGas).Constant(_idConstant_DensidadNaturalGas));
                _operands.Add("B", EMSLibrary.User.PerformanceAssessments.Configuration.Measurement(idMeasurement_PCNaturalGas));
                _operands.Add("C", EMSLibrary.User.PerformanceAssessments.Configuration.Measurement(idMeasurement_EFNaturalGas_CH4));
            ...
            private Dictionary<String, Condesus.EMS.Business.IOperand> BuildOperatorForTransformation7(Int64 idMeasurement_PCNaturalGas, Int64 idMeasurement_EFNaturalGas_N2O)
            {
                Dictionary<String, Condesus.EMS.Business.IOperand> _operands = new Dictionary<String, Condesus.EMS.Business.IOperand>();
                ...
                _operands.Add("A", EMSLibrary.User.PerformanceAssessments.Configuration.ConstantClassification(_idConstantClass_DensidadNaturalGas).Constant(_idConstant_DensidadNaturalGas));
                _operands.Add("B", EMSLibrary.User.PerformanceAssessments.Configuration.Measurement(idMeasurement_PCNaturalGas));
                _operands.Add("C", EMSLibrary.User.PerformanceAssessments.Configuration.Measurement(idMeasurement_EFNaturalGas_N2O));
                    ...
                    using (TransactionScope _transactionScope = new TransactionScope(new TransactionScopeOption(), new TimeSpan(0, 10, 0)))
                    {
                        ...
                        foreach (String _item in _SitesAux)
                        {
                            ...
                            CalculateOfTransformation _calculateOfTransformation_1 = TransformationAdd(_idIndicatorCO2, _idMeasurementUnit_ton,
                                _taskMeasurementBase.Measurement, null, BuildOperatorForTransformation1(_idMeasurement_PCNaturalGas, _idMeasurement_EFNaturalGas_CO2), _transformationName, txtDescription.Text, "Base*A/1000000*B*C");
                            #endregion
                            ...
                            CalculateOfTransformation _calculateOfTransformation_4 = TransformationAdd(_idIndicatorCH4, _idMeasurementUnit_ton,
                                _taskMeasurementBase.Measurement, null, BuildOperatorForTransformation4(_idMeasurement_PCNaturalGas, _idMeasurement_EFNaturalGas_CH4), _transformationName, txtDescription.Text, "Base*A/1000000*B*C");
                            #endregion
                            ...
                            CalculateOfTransformation _calculateOfTransformation_7 = TransformationAdd(_idIndicatorN2O, _idMeasurementUnit_ton,
                                _taskMeasurementBase.Measurement, null, BuildOperatorForTransformation7(_idMeasurement_PCNaturalGas, _idMeasurement_EFNaturalGas_N2O), _transformationName, txtDescription.Text, "Base*A*B*C");
                            #endregion
