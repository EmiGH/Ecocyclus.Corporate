...
{
    public partial class ScriptDieselTransfo : BasePropertiesTask
    {
        ...
        #region Private Methods
            ...
            private Boolean ValidateComboConstantSelected()
            {
                ...
                if (Convert.ToInt64(GetKeyValue(_RtvConstant_EFDiesel_CH4.SelectedNode.Value, "IdConstantClassification")) == 0)
                {
                    return false;
                }
                if (Convert.ToInt64(GetKeyValue(_RtvConstant_EFDiesel_N2O.SelectedNode.Value, "IdConstantClassification")) == 0)
                {
                    return false;
                }
                if (Convert.ToInt64(GetKeyValue(_RtvConstant_EFDiesel_CO2.SelectedNode.Value, "IdConstantClassification")) == 0)
                {
                    return false;
                }
                if (Convert.ToInt64(GetKeyValue(_RtvConstant_PCDiesel.SelectedNode.Value, "IdConstantClassification")) == 0)
                {
                    return false;
                }
                ...
                if (Convert.ToInt64(GetKeyValue(_RtvConstant_DesidadDiesel.SelectedNode.Value, "IdConstantClassification")) == 0)
                {
                    return false;
                }
