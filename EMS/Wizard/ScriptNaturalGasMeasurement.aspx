<%@ Page Title="" Language="C#" MasterPageFile="~/EMS.Master" AutoEventWireup="true" CodeBehind="ScriptNaturalGasMeasurement.aspx.cs" 
Inherits="Condesus.EMS.WebUI.Wizard.ScriptNaturalGasMeasurement" %>
        ...
        <tr>
            <td>
                <table id="tblContentForm" runat="server" class="ContentForm">
                    ...
                    <!-- Medición 15. Factor de Emision de CH4 -->
                    <tr>
                        <td class="ColTitle">
                            <asp:Label ID="lblMeasurementFECH4" runat="server" Text="Factor de Emision de CH4:" />
                        </td>
                        <td class="ColContent">
                            <asp:UpdatePanel ID="upMeasurement" runat="server" UpdateMode="Always">
                                <ContentTemplate>
                                    <asp:PlaceHolder ID="phMeasurementFECH4" runat="server" />
                                </ContentTemplate>
                            </asp:UpdatePanel>
                        </td>
                        <td class="ColValidator">
                    ...
                    <!-- Medición 16. Factor de Emision de N2O -->
                    <tr>
                        <td class="ColTitle">
                            <asp:Label ID="lblMeasurementFEN2O" runat="server" Text="Factor de Emision de N2O:" />
                        </td>
                        <td class="ColContent">
                            <asp:UpdatePanel ID="upMeasurementFEN2O" runat="server" UpdateMode="Always">
                                <ContentTemplate>
                                    <asp:PlaceHolder ID="phMeasurementFEN2O" runat="server" />
                                </ContentTemplate>
                            </asp:UpdatePanel>
                        </td>
                        <td class="ColValidator">
                    ...
                    <!-- Medición 17. Factor de Emision de CO2 -->
                    <tr>
                        <td class="ColTitle">
                            <asp:Label ID="lblMeasurementFECO2" runat="server" Text="Factor de Emision de CO2:" />
                        </td>
                        <td class="ColContent">
                            <asp:UpdatePanel ID="upMeasurementFECO2" runat="server" UpdateMode="Always">
                                <ContentTemplate>
                                    <asp:PlaceHolder ID="phMeasurementFECO2" runat="server" />
                                </ContentTemplate>
                            </asp:UpdatePanel>
                        </td>
                        <td class="ColValidator">
                    ...
                    <!-- Medición 18. Poder Calorifico del NaturalGas -->
                    <tr>
                        <td class="ColTitle">
                            <asp:Label ID="lblMeasurementPCNaturalGas" runat="server" Text="Poder Calorifico del NaturalGas:" />
                        </td>
                        <td class="ColContent">
                            <asp:UpdatePanel ID="upMeasurementPCNaturalGas" runat="server" UpdateMode="Always">
                                <ContentTemplate>
                                    <asp:PlaceHolder ID="phMeasurementPCNaturalGas" runat="server" />
                                </ContentTemplate>
                            </asp:UpdatePanel>
                        </td>
                        <td class="ColValidator">
                    ...
                    <!-- Medición 19. Factor de Emision del NaturalGas para CO2 -->
                    <tr>
                        <td class="ColTitle">
                            <asp:Label ID="lblMeasurementFENaturalGasCO2" runat="server" Text="Factor de Emision del NaturalGas para CO2:" />
                        </td>
                        <td class="ColContent">
                            <asp:UpdatePanel ID="upMeasurementFENaturalGasCO2" runat="server" UpdateMode="Always">
                                <ContentTemplate>
                                    <asp:PlaceHolder ID="phMeasurementFENaturalGasCO2" runat="server" />
                                </ContentTemplate>
                            </asp:UpdatePanel>
                        </td>
                        <td class="ColValidator">
                    ...
                    <!-- Medición 20. Factor de Emision del NaturalGas para CH4 -->
                    <tr>
                        <td class="ColTitle">
                            <asp:Label ID="lblMeasurementFENaturalGasCH4" runat="server" Text="Factor de Emision del NaturalGas para CH4:" />
                        </td>
                        <td class="ColContent">
                            <asp:UpdatePanel ID="upMeasurementFENaturalGasCH4" runat="server" UpdateMode="Always">
                                <ContentTemplate>
                                    <asp:PlaceHolder ID="phMeasurementFENaturalGasCH4" runat="server" />
                                </ContentTemplate>
                            </asp:UpdatePanel>
                        </td>
                        <td class="ColValidator">
                    ...
                    <!-- Medición 21. Factor de Emision del NaturalGas para N2O -->
                    <tr>
                        <td class="ColTitle">
                            <asp:Label ID="lblMeasurementFENaturalGasN2O" runat="server" Text="Factor de Emision del NaturalGas para N2O:" />
                        </td>
                        <td class="ColContent">
                            <asp:UpdatePanel ID="upMeasurementFENaturalGasN2O" runat="server" UpdateMode="Always">
                                <ContentTemplate>
                                    <asp:PlaceHolder ID="phMeasurementFENaturalGasN2O" runat="server" />
                                </ContentTemplate>
                            </asp:UpdatePanel>
                        </td>
                        <td class="ColValidator">
