...
{
    public partial class ScriptKeroseneMeasurement : BasePropertiesTask
    {
        ...
        #region Measurements
            ...
            private RadComboBox _RdcMeasurement_PCKerosene;
            private RadComboBox _RdcMeasurement_EFKerosene_CO2;
            private RadComboBox _RdcMeasurement_EFKerosene_CH4;
            private RadComboBox _RdcMeasurement_EFKerosene_N2O;
        #endregion
        ...
        #region PageLoad & Init
            ...
            protected override void OnLoad(EventArgs e)
            {
                ...
                AddComboMeasurement_PCKerosene();
                AddComboMeasurementFEKerosene_CO2();
                AddComboMeasurementFEKerosene_CH4();
                AddComboMeasurementFEKerosene_N2O();
        ...
        #region Private Methods
            ...
            private void AddComboMeasurement_PCKerosene()
            {
                Dictionary<String, Object> _params = new Dictionary<String, Object>();
                if (_params.ContainsKey("IdProcess"))
                { _params.Remove("IdProcess"); }
                ...
                AddCombo(phMeasurementPCKerosene, ref _RdcMeasurement_PCKerosene, Common.ConstantsEntitiesName.PA.Measurements, String.Empty, _params, false, true, false, false, false);
            }
            private void AddComboMeasurementFEKerosene_CO2()
            {
                Dictionary<String, Object> _params = new Dictionary<String, Object>();
                if (_params.ContainsKey("IdProcess"))
                { _params.Remove("IdProcess"); }
                ...
                AddCombo(phMeasurementFEKeroseneCO2, ref _RdcMeasurement_EFKerosene_CO2, Common.ConstantsEntitiesName.PA.Measurements, String.Empty, _params, false, true, false, false, false);
            }
            private void AddComboMeasurementFEKerosene_CH4()
            {
                Dictionary<String, Object> _params = new Dictionary<String, Object>();
                if (_params.ContainsKey("IdProcess"))
                { _params.Remove("IdProcess"); }
                ...
                AddCombo(phMeasurementFEKeroseneCH4, ref _RdcMeasurement_EFKerosene_CH4, Common.ConstantsEntitiesName.PA.Measurements, String.Empty, _params, false, true, false, false, false);
            }
            private void AddComboMeasurementFEKerosene_N2O()
            {
                Dictionary<String, Object> _params = new Dictionary<String, Object>();
                if (_params.ContainsKey("IdProcess"))
                { _params.Remove("IdProcess"); }
                ...
                AddCombo(phMeasurementFEKeroseneN2O, ref _RdcMeasurement_EFKerosene_N2O, Common.ConstantsEntitiesName.PA.Measurements, String.Empty, _params, false, true, false, false, false);
            }
            ...
            private Dictionary<String, Condesus.EMS.Business.IOperand> BuildOperatorForTransformation1(Int64 idMeasurement_PCKerosene, Int64 idMeasurement_EFKerosene_CO2)
            {
                Dictionary<String, Condesus.EMS.Business.IOperand> _operands = new Dictionary<String, Condesus.EMS.Business.IOperand>();

                Int64 _idConstantClass_DensidadKerosene = 7;
                Int64 _idConstant_DensidadKerosene = 10;
                ...
                _operands.Add("B", EMSLibrary.User.PerformanceAssessments.Configuration.Measurement(idMeasurement_PCKerosene));
                _operands.Add("C", EMSLibrary.User.PerformanceAssessments.Configuration.Measurement(idMeasurement_EFKerosene_CO2));
            ...
            private Dictionary<String, Condesus.EMS.Business.IOperand> BuildOperatorForTransformation4(Int64 idMeasurement_PCKerosene, Int64 idMeasurement_EFKerosene_CH4)
            {
                Dictionary<String, Condesus.EMS.Business.IOperand> _operands = new Dictionary<String, Condesus.EMS.Business.IOperand>();
                ...
                _operands.Add("A", EMSLibrary.User.PerformanceAssessments.Configuration.ConstantClassification(_idConstantClass_DensidadKerosene).Constant(_idConstant_DensidadKerosene));
                _operands.Add("B", EMSLibrary.User.PerformanceAssessments.Configuration.Measurement(idMeasurement_PCKerosene));
                _operands.Add("C", EMSLibrary.User.PerformanceAssessments.Configuration.Measurement(idMeasurement_EFKerosene_CH4));
            ...
            private Dictionary<String, Condesus.EMS.Business.IOperand> BuildOperatorForTransformation7(Int64 idMeasurement_PCKerosene, Int64 idMeasurement_EFKerosene_N2O)
            {
                Dictionary<String, Condesus.EMS.Business.IOperand> _operands = new Dictionary<String, Condesus.EMS.Business.IOperand>();
                ...
                _operands.Add("A", EMSLibrary.User.PerformanceAssessments.Configuration.ConstantClassification(_idConstantClass_DensidadKerosene).Constant(_idConstant_DensidadKerosene));
                _operands.Add("B", EMSLibrary.User.PerformanceAssessments.Configuration.Measurement(idMeasurement_PCKerosene));
                _operands.Add("C", EMSLibrary.User.PerformanceAssessments.Configuration.Measurement(idMeasurement_EFKerosene_N2O));
                    ...
                    using (TransactionScope _transactionScope = new TransactionScope(new TransactionScopeOption(), new TimeSpan(0, 10, 0)))
                    {
                        ...
                        foreach (String _item in _SitesAux)
                        {
                            ...
                            CalculateOfTransformation _calculateOfTransformation_1 = TransformationAdd(_idIndicatorCO2, _idMeasurementUnit_ton,
                                _taskMeasurementBase.Measurement, null, BuildOperatorForTransformation1(_idMeasurement_PCKerosene, _idMeasurement_EFKerosene_CO2), _transformationName, txtDescription.Text, "Base*A/1000000*B*C");
                            #endregion
                            ...
                            CalculateOfTransformation _calculateOfTransformation_4 = TransformationAdd(_idIndicatorCH4, _idMeasurementUnit_ton,
                                _taskMeasurementBase.Measurement, null, BuildOperatorForTransformation4(_idMeasurement_PCKerosene, _idMeasurement_EFKerosene_CH4), _transformationName, txtDescription.Text, "Base*A/1000000*B*C");
                            #endregion
                            ...
                            CalculateOfTransformation _calculateOfTransformation_7 = TransformationAdd(_idIndicatorN2O, _idMeasurementUnit_ton,
                                _taskMeasurementBase.Measurement, null, BuildOperatorForTransformation7(_idMeasurement_PCKerosene, _idMeasurement_EFKerosene_N2O), _transformationName, txtDescription.Text, "Base*A*B*C");
                            #endregion
