...
{
    public partial class ScriptNaturalGasTransfo : BasePropertiesTask
    {
        ...
        #region Private Methods
            ...
            {
                Page.Title = Resources.CommonListManage.ScriptEngine;
            }
            ...
            private Boolean ValidateComboConstantSelected()
            {
                ...
                if (Convert.ToInt64(GetKeyValue(_RtvConstant_EFNaturalGas_CH4.SelectedNode.Value, "IdConstantClassification")) == 0)
                {
                    return false;
                }
                if (Convert.ToInt64(GetKeyValue(_RtvConstant_EFNaturalGas_N2O.SelectedNode.Value, "IdConstantClassification")) == 0)
                {
                    return false;
                }
                if (Convert.ToInt64(GetKeyValue(_RtvConstant_EFNaturalGas_CO2.SelectedNode.Value, "IdConstantClassification")) == 0)
                {
                    return false;
                }
                if (Convert.ToInt64(GetKeyValue(_RtvConstant_PCNaturalGas.SelectedNode.Value, "IdConstantClassification")) == 0)
                {
                    return false;
                }
                ...
                if (Convert.ToInt64(GetKeyValue(_RtvConstant_DesidadNaturalGas.SelectedNode.Value, "IdConstantClassification")) == 0)
                {
                    return false;
                }
                ...
                try
                {
                    if (ValidateComboConstantSelected())
                    {
                        ...
                        using (TransactionScope _transactionScope = new TransactionScope(new TransactionScopeOption(), new TimeSpan(0, 10, 0)))
                        {
                            ...
                            //Int64 _idMeasurement_PCNaturalGas = Convert.ToInt64(GetKeyValue(_RdcMeasurement_PCNaturalGas.SelectedValue, "IdMeasurement"));
                            //Int64 _idMeasurement_EFNaturalGas_CO2 = Convert.ToInt64(GetKeyValue(_RdcMeasurement_EFNaturalGas_CO2.SelectedValue, "IdMeasurement"));
                            //Int64 _idMeasurement_EFNaturalGas_CH4 = Convert.ToInt64(GetKeyValue(_RdcMeasurement_EFNaturalGas_CH4.SelectedValue, "IdMeasurement"));
                            //Int64 _idMeasurement_EFNaturalGas_N2O = Convert.ToInt64(GetKeyValue(_RdcMeasurement_EFNaturalGas_N2O.SelectedValue, "IdMeasurement"));
