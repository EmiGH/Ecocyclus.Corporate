...
{
    public partial class ScriptDiesel : BasePropertiesTask
    {
        ...
        #region Constants
            private RadComboBox _RdcConst_DesidadDiesel;
            private RadTreeView _RtvConstant_DesidadDiesel;
            ...
            private RadComboBox _RdcConst_PCDiesel;
            private RadTreeView _RtvConstant_PCDiesel;
            private RadComboBox _RdcConst_EFDiesel_CO2;
            private RadTreeView _RtvConstant_EFDiesel_CO2;
            private RadComboBox _RdcConst_EFDiesel_CH4;
            private RadTreeView _RtvConstant_EFDiesel_CH4;
            private RadComboBox _RdcConst_EFDiesel_N2O;
            private RadTreeView _RtvConstant_EFDiesel_N2O;
        #endregion
        ...
        #region PageLoad & Init
            ...
            protected override void OnLoad(EventArgs e)
            {
                ...
                AddComboConst_DesidadDiesel();
                AddComboConst_PCG_CH4();
                AddComboConst_PCG_N2O();

                AddComboConst_PCDiesel();
                AddComboConstFEDiesel_CO2();
                AddComboConstFEDiesel_CH4();
                AddComboConstFEDiesel_N2O();
        ...
        #region Private Methods
            ...
            {
                Int64 _idIndicatorDiesel = 73; //Para Demo  // 13; //Para Ghree
                Int64 _idNoConditionDiesel = 64;//Para Demo // 13; //Para Ghree
            ...
            private void AddComboConst_DesidadDiesel()
            {
                Dictionary<String, Object> _params = new Dictionary<String, Object>();
                AddComboTreeConstant(ref phConstDesidadDiesel, ref _RdcConst_DesidadDiesel, ref _RtvConstant_DesidadDiesel, new RadTreeViewEventHandler(rtvConst_NodeExpand));
            }
            ...
            private void AddComboConst_PCDiesel()
            {
                Dictionary<String, Object> _params = new Dictionary<String, Object>();
                AddComboTreeConstant(ref phConstPCDiesel, ref _RdcConst_PCDiesel, ref _RtvConstant_PCDiesel, new RadTreeViewEventHandler(rtvConst_NodeExpand));
            }
            private void AddComboConstFEDiesel_CO2()
            {
                Dictionary<String, Object> _params = new Dictionary<String, Object>();
                AddComboTreeConstant(ref phConstFEDieselCO2, ref _RdcConst_EFDiesel_CO2, ref _RtvConstant_EFDiesel_CO2, new RadTreeViewEventHandler(rtvConst_NodeExpand));
            }
            private void AddComboConstFEDiesel_CH4()
            {
                Dictionary<String, Object> _params = new Dictionary<String, Object>();
                AddComboTreeConstant(ref phConstFEDieselCH4, ref _RdcConst_EFDiesel_CH4, ref _RtvConstant_EFDiesel_CH4, new RadTreeViewEventHandler(rtvConst_NodeExpand));
            }
            private void AddComboConstFEDiesel_N2O()
            {
                Dictionary<String, Object> _params = new Dictionary<String, Object>();
                AddComboTreeConstant(ref phConstFEDieselN2O, ref _RdcConst_EFDiesel_N2O, ref _RtvConstant_EFDiesel_N2O, new RadTreeViewEventHandler(rtvConst_NodeExpand));
            }
            ...
            private Dictionary<String, Condesus.EMS.Business.IOperand> BuildOperatorForTransformation1()
            {
                ...
                Int64 _idConstantClass_EFDiesel_CH4 = Convert.ToInt64(GetKeyValue(_RtvConstant_EFDiesel_CH4.SelectedNode.Value, "IdConstantClassification"));
                Int64 _idConstantClass_EFDiesel_N2O = Convert.ToInt64(GetKeyValue(_RtvConstant_EFDiesel_N2O.SelectedNode.Value, "IdConstantClassification"));
                Int64 _idConstantClass_EFDiesel_CO2 = Convert.ToInt64(GetKeyValue(_RtvConstant_EFDiesel_CO2.SelectedNode.Value, "IdConstantClassification"));
                Int64 _idConstantClass_PCDiesel = Convert.ToInt64(GetKeyValue(_RtvConstant_PCDiesel.SelectedNode.Value, "IdConstantClassification"));

                Int64 _idConstant_EFDiesel_CH4 = Convert.ToInt64(GetKeyValue(_RtvConstant_EFDiesel_CH4.SelectedNode.Value, "IdConstant"));
                Int64 _idConstant_EFDiesel_N2O = Convert.ToInt64(GetKeyValue(_RtvConstant_EFDiesel_N2O.SelectedNode.Value, "IdConstant"));
                Int64 _idConstant_EFDiesel_CO2 = Convert.ToInt64(GetKeyValue(_RtvConstant_EFDiesel_CO2.SelectedNode.Value, "IdConstant"));
                Int64 _idConstant_PCDiesel = Convert.ToInt64(GetKeyValue(_RtvConstant_PCDiesel.SelectedNode.Value, "IdConstant"));

                Int64 _idConstantClass_DensidadDiesel = Convert.ToInt64(GetKeyValue(_RtvConstant_DesidadDiesel.SelectedNode.Value, "IdConstantClassification"));
                Int64 _idConstant_DensidadDiesel = Convert.ToInt64(GetKeyValue(_RtvConstant_DesidadDiesel.SelectedNode.Value, "IdConstant")); ;
                ...
                _operands.Add("B", EMSLibrary.User.PerformanceAssessments.Configuration.ConstantClassification(_idConstantClass_PCDiesel).Constant(_idConstant_PCDiesel));
                _operands.Add("C", EMSLibrary.User.PerformanceAssessments.Configuration.ConstantClassification(_idConstantClass_EFDiesel_CO2).Constant(_idConstant_EFDiesel_CO2));
            ...
            private Dictionary<String, Condesus.EMS.Business.IOperand> BuildOperatorForTransformation4()
            {
                ...
                _operands.Add("A", EMSLibrary.User.PerformanceAssessments.Configuration.ConstantClassification(_idConstantClass_DensidadDiesel).Constant(_idConstant_DensidadDiesel));
                _operands.Add("B", EMSLibrary.User.PerformanceAssessments.Configuration.ConstantClassification(_idConstantClass_PCDiesel).Constant(_idConstant_PCDiesel));
                _operands.Add("C", EMSLibrary.User.PerformanceAssessments.Configuration.ConstantClassification(_idConstantClass_EFDiesel_CH4).Constant(_idConstant_EFDiesel_CH4));
            ...
            private Dictionary<String, Condesus.EMS.Business.IOperand> BuildOperatorForTransformation7()
            {
                ...
                _operands.Add("A", EMSLibrary.User.PerformanceAssessments.Configuration.ConstantClassification(_idConstantClass_DensidadDiesel).Constant(_idConstant_DensidadDiesel));
                _operands.Add("B", EMSLibrary.User.PerformanceAssessments.Configuration.ConstantClassification(_idConstantClass_PCDiesel).Constant(_idConstant_PCDiesel));
                _operands.Add("C", EMSLibrary.User.PerformanceAssessments.Configuration.ConstantClassification(_idConstantClass_EFDiesel_N2O).Constant(_idConstant_EFDiesel_N2O));
