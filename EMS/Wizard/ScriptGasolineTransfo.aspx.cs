...
{
    public partial class ScriptGasolineTransfo : BasePropertiesTask
    {
        ...
        #region Private Methods
            ...
            private Boolean ValidateComboConstantSelected()
            {
                ...
                if (Convert.ToInt64(GetKeyValue(_RtvConstant_EFGasoline_CH4.SelectedNode.Value, "IdConstantClassification")) == 0)
                {
                    return false;
                }
                if (Convert.ToInt64(GetKeyValue(_RtvConstant_EFGasoline_N2O.SelectedNode.Value, "IdConstantClassification")) == 0)
                {
                    return false;
                }
                if (Convert.ToInt64(GetKeyValue(_RtvConstant_EFGasoline_CO2.SelectedNode.Value, "IdConstantClassification")) == 0)
                {
                    return false;
                }
                if (Convert.ToInt64(GetKeyValue(_RtvConstant_PCGasoline.SelectedNode.Value, "IdConstantClassification")) == 0)
                {
                    return false;
                }
                ...
                if (Convert.ToInt64(GetKeyValue(_RtvConstant_DesidadGasoline.SelectedNode.Value, "IdConstantClassification")) == 0)
                {
                    return false;
                }
                ...
                try
                {
                    if (ValidateComboConstantSelected())
                    {
                        ...
                        using (TransactionScope _transactionScope = new TransactionScope(new TransactionScopeOption(), new TimeSpan(0, 10, 0)))
                        {
                            ...
                            //Int64 _idMeasurement_PCGasoline = Convert.ToInt64(GetKeyValue(_RdcMeasurement_PCGasoline.SelectedValue, "IdMeasurement"));
                            //Int64 _idMeasurement_EFGasoline_CO2 = Convert.ToInt64(GetKeyValue(_RdcMeasurement_EFGasoline_CO2.SelectedValue, "IdMeasurement"));
                            //Int64 _idMeasurement_EFGasoline_CH4 = Convert.ToInt64(GetKeyValue(_RdcMeasurement_EFGasoline_CH4.SelectedValue, "IdMeasurement"));
                            //Int64 _idMeasurement_EFGasoline_N2O = Convert.ToInt64(GetKeyValue(_RdcMeasurement_EFGasoline_N2O.SelectedValue, "IdMeasurement"));
