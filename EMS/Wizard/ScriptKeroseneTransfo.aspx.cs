...
{
    public partial class ScriptKeroseneTransfo : BasePropertiesTask
    {
        #region Internal Properties
            #region Constants
                private RadComboBox _RdcConst_DesidadKerosene;
                private RadTreeView _RtvConstant_DesidadKerosene;
                ...
                private RadComboBox _RdcConst_PCKerosene;
                private RadTreeView _RtvConstant_PCKerosene;
                private RadComboBox _RdcConst_EFKerosene_CO2;
                private RadTreeView _RtvConstant_EFKerosene_CO2;
                private RadComboBox _RdcConst_EFKerosene_CH4;
                private RadTreeView _RtvConstant_EFKerosene_CH4;
                private RadComboBox _RdcConst_EFKerosene_N2O;
                private RadTreeView _RtvConstant_EFKerosene_N2O;
            #endregion
        ...
        #region PageLoad & Init
            ...
            protected override void OnLoad(EventArgs e)
            {
                ...
                AddComboProcess();
                AddComboConst_DesidadKerosene();
                AddComboConst_PCG_CH4();
                AddComboConst_PCG_N2O();

                AddComboConst_PCKerosene();
                AddComboConstFEKerosene_CO2();
                AddComboConstFEKerosene_CH4();
                AddComboConstFEKerosene_N2O();
            ...
            {
                base.PageTitle = Resources.CommonListManage.ScriptKerosene;
            }
        ...
        #region Private Methods
            ...
            {
                Page.Title = Resources.CommonListManage.ScriptKerosene;
            }
            ...
            private void AddComboConst_DesidadKerosene()
            {
                Dictionary<String, Object> _params = new Dictionary<String, Object>();
                AddComboTreeConstant(ref phConstDesidadKerosene, ref _RdcConst_DesidadKerosene, ref _RtvConstant_DesidadKerosene, new RadTreeViewEventHandler(rtvConst_NodeExpand));
            }
            ...
            private void AddComboConst_PCKerosene()
            {
                Dictionary<String, Object> _params = new Dictionary<String, Object>();
                AddComboTreeConstant(ref phConstPCKerosene, ref _RdcConst_PCKerosene, ref _RtvConstant_PCKerosene, new RadTreeViewEventHandler(rtvConst_NodeExpand));
            }
            private void AddComboConstFEKerosene_CO2()
            {
                Dictionary<String, Object> _params = new Dictionary<String, Object>();
                AddComboTreeConstant(ref phConstFEKeroseneCO2, ref _RdcConst_EFKerosene_CO2, ref _RtvConstant_EFKerosene_CO2, new RadTreeViewEventHandler(rtvConst_NodeExpand));
            }
            private void AddComboConstFEKerosene_CH4()
            {
                Dictionary<String, Object> _params = new Dictionary<String, Object>();
                AddComboTreeConstant(ref phConstFEKeroseneCH4, ref _RdcConst_EFKerosene_CH4, ref _RtvConstant_EFKerosene_CH4, new RadTreeViewEventHandler(rtvConst_NodeExpand));
            }
            private void AddComboConstFEKerosene_N2O()
            {
                Dictionary<String, Object> _params = new Dictionary<String, Object>();
                AddComboTreeConstant(ref phConstFEKeroseneN2O, ref _RdcConst_EFKerosene_N2O, ref _RtvConstant_EFKerosene_N2O, new RadTreeViewEventHandler(rtvConst_NodeExpand));
            }

            private Boolean ValidateComboConstantSelected()
            {

                if (Convert.ToInt64(GetKeyValue(_RtvConstant_EFKerosene_CH4.SelectedNode.Value, "IdConstantClassification")) == 0)
                {
                    return false;
                }
                if (Convert.ToInt64(GetKeyValue(_RtvConstant_EFKerosene_N2O.SelectedNode.Value, "IdConstantClassification")) == 0)
                {
                    return false;
                }
                if (Convert.ToInt64(GetKeyValue(_RtvConstant_EFKerosene_CO2.SelectedNode.Value, "IdConstantClassification")) == 0)
                {
                    return false;
                }
                if (Convert.ToInt64(GetKeyValue(_RtvConstant_PCKerosene.SelectedNode.Value, "IdConstantClassification")) == 0)
                {
                    return false;
                }
                ...
                if (Convert.ToInt64(GetKeyValue(_RtvConstant_DesidadKerosene.SelectedNode.Value, "IdConstantClassification")) == 0)
                {
                    return false;
                }
            ...
            #region Transformation Add
                ...
                private Dictionary<String, Condesus.EMS.Business.IOperand> BuildOperatorForTransformation1()
                {
                    ...
                    Int64 _idConstantClass_EFKerosene_CH4 = Convert.ToInt64(GetKeyValue(_RtvConstant_EFKerosene_CH4.SelectedNode.Value, "IdConstantClassification"));
                    Int64 _idConstantClass_EFKerosene_N2O = Convert.ToInt64(GetKeyValue(_RtvConstant_EFKerosene_N2O.SelectedNode.Value, "IdConstantClassification"));
                    Int64 _idConstantClass_EFKerosene_CO2 = Convert.ToInt64(GetKeyValue(_RtvConstant_EFKerosene_CO2.SelectedNode.Value, "IdConstantClassification"));
                    Int64 _idConstantClass_PCKerosene = Convert.ToInt64(GetKeyValue(_RtvConstant_PCKerosene.SelectedNode.Value, "IdConstantClassification"));

                    Int64 _idConstant_EFKerosene_CH4 = Convert.ToInt64(GetKeyValue(_RtvConstant_EFKerosene_CH4.SelectedNode.Value, "IdConstant"));
                    Int64 _idConstant_EFKerosene_N2O = Convert.ToInt64(GetKeyValue(_RtvConstant_EFKerosene_N2O.SelectedNode.Value, "IdConstant"));
                    Int64 _idConstant_EFKerosene_CO2 = Convert.ToInt64(GetKeyValue(_RtvConstant_EFKerosene_CO2.SelectedNode.Value, "IdConstant"));
                    Int64 _idConstant_PCKerosene = Convert.ToInt64(GetKeyValue(_RtvConstant_PCKerosene.SelectedNode.Value, "IdConstant"));

                    Int64 _idConstantClass_DensidadKerosene = Convert.ToInt64(GetKeyValue(_RtvConstant_DesidadKerosene.SelectedNode.Value, "IdConstantClassification"));
                    Int64 _idConstant_DensidadKerosene = Convert.ToInt64(GetKeyValue(_RtvConstant_DesidadKerosene.SelectedNode.Value, "IdConstant")); ;

                    _operands.Add("A", EMSLibrary.User.PerformanceAssessments.Configuration.ConstantClassification(_idConstantClass_DensidadKerosene).Constant(_idConstant_DensidadKerosene));
                    _operands.Add("B", EMSLibrary.User.PerformanceAssessments.Configuration.ConstantClassification(_idConstantClass_PCKerosene).Constant(_idConstant_PCKerosene));
                    _operands.Add("C", EMSLibrary.User.PerformanceAssessments.Configuration.ConstantClassification(_idConstantClass_EFKerosene_CO2).Constant(_idConstant_EFKerosene_CO2));
                ...
                private Dictionary<String, Condesus.EMS.Business.IOperand> BuildOperatorForTransformation4()
                {
                    ...
                    _operands.Add("A", EMSLibrary.User.PerformanceAssessments.Configuration.ConstantClassification(_idConstantClass_DensidadKerosene).Constant(_idConstant_DensidadKerosene));
                    _operands.Add("B", EMSLibrary.User.PerformanceAssessments.Configuration.ConstantClassification(_idConstantClass_PCKerosene).Constant(_idConstant_PCKerosene));
                    _operands.Add("C", EMSLibrary.User.PerformanceAssessments.Configuration.ConstantClassification(_idConstantClass_EFKerosene_CH4).Constant(_idConstant_EFKerosene_CH4));
                ...
                private Dictionary<String, Condesus.EMS.Business.IOperand> BuildOperatorForTransformation7()
                {
                    ...
                    _operands.Add("A", EMSLibrary.User.PerformanceAssessments.Configuration.ConstantClassification(_idConstantClass_DensidadKerosene).Constant(_idConstant_DensidadKerosene));
                    _operands.Add("B", EMSLibrary.User.PerformanceAssessments.Configuration.ConstantClassification(_idConstantClass_PCKerosene).Constant(_idConstant_PCKerosene));
                    _operands.Add("C", EMSLibrary.User.PerformanceAssessments.Configuration.ConstantClassification(_idConstantClass_EFKerosene_N2O).Constant(_idConstant_EFKerosene_N2O));
                ...
                try
                {
                    if (ValidateComboConstantSelected())
                    {
                        ...
                        using (TransactionScope _transactionScope = new TransactionScope(new TransactionScopeOption(), new TimeSpan(0, 10, 0)))
                        {
                            ...
                            //Int64 _idMeasurement_PCKerosene = Convert.ToInt64(GetKeyValue(_RdcMeasurement_PCKerosene.SelectedValue, "IdMeasurement"));
                            //Int64 _idMeasurement_EFKerosene_CO2 = Convert.ToInt64(GetKeyValue(_RdcMeasurement_EFKerosene_CO2.SelectedValue, "IdMeasurement"));
                            //Int64 _idMeasurement_EFKerosene_CH4 = Convert.ToInt64(GetKeyValue(_RdcMeasurement_EFKerosene_CH4.SelectedValue, "IdMeasurement"));
                            //Int64 _idMeasurement_EFKerosene_N2O = Convert.ToInt64(GetKeyValue(_RdcMeasurement_EFKerosene_N2O.SelectedValue, "IdMeasurement"));
