<%@ Page Title="" Language="C#" MasterPageFile="~/EMS.Master" AutoEventWireup="true" CodeBehind="ScriptElectricityConst.aspx.cs" 
Inherits="Condesus.EMS.WebUI.Wizard.ScriptElectricityConst" %>
        ...
        <tr>
            <td>
                <table id="tblContentForm" runat="server" class="ContentForm">
                    ...
                    <!-- SELECCION DE 1 CONSTANTE que es el factor de emision de la Red!!! -->
                    <!-- Medición a-	Factor de Emision de la Red -->
                    <tr>
                        <td class="ColTitle">
                            <asp:Label ID="lblMeasurement2" runat="server" Text="Factor de Emision de la Red:" />
                        </td>
                        <td class="ColContent">
                            <asp:PlaceHolder ID="phConstEFRed" runat="server" />
                        </td>
                        <td class="ColValidator">
                            &nbsp;
                        </td>
