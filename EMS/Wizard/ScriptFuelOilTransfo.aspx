<%@ Page Title="" Language="C#" MasterPageFile="~/EMS.Master" AutoEventWireup="true" CodeBehind="ScriptFuelOilTransfo.aspx.cs" 
Inherits="Condesus.EMS.WebUI.Wizard.ScriptFuelOilTransfo" %>
        ...
        <tr>
            <td>
                <table id="tblContentForm" runat="server" class="ContentForm">
                    ...
                    <!-- Constante a- Densidad FuelOil -->
                    <tr>
                        <td class="ColTitle">
                            <asp:Label ID="lblConstDesidadFuelOil" runat="server" Text="Densidad del FuelOil:" />
                        </td>
                        <td class="ColContent">
                            <asp:PlaceHolder ID="phConstDesidadFuelOil" runat="server" />
                        </td>
                        <td class="ColValidator">
                            &nbsp;
                        </td>
                    ...
                    <!-- Constante 18. Poder Calorifico del FuelOil -->
                    <tr>
                        <td class="ColTitle">
                            <asp:Label ID="lblConstPCFuelOil" runat="server" Text="Poder Calorifico del FuelOil:" />
                        </td>
                        <td class="ColContent">
                            <asp:PlaceHolder ID="phConstPCFuelOil" runat="server" />
                        </td>
                        <td class="ColValidator">
                            &nbsp;
                        </td>
                    </tr> 
                    <!-- Constante 19. Factor de Emision del FuelOil para CO2 -->
                    <tr>
                        <td class="ColTitle">
                            <asp:Label ID="lblConstFEFuelOilCO2" runat="server" Text="Factor de Emision del FuelOil para CO2:" />
                        </td>
                        <td class="ColContent">
                            <asp:PlaceHolder ID="phConstFEFuelOilCO2" runat="server" />
                        </td>
                        <td class="ColValidator">
                            &nbsp;
                        </td>
                    </tr> 
                    <!-- Constante 20. Factor de Emision del FuelOil para CH4 -->
                    <tr>
                        <td class="ColTitle">
                            <asp:Label ID="lblConstFEFuelOilCH4" runat="server" Text="Factor de Emision del FuelOil para CH4:" />
                        </td>
                        <td class="ColContent">
                            <asp:PlaceHolder ID="phConstFEFuelOilCH4" runat="server" />
                        </td>
                        <td class="ColValidator">
                            &nbsp;
                        </td>
                    </tr> 
                    <!-- Constante 21. Factor de Emision del FuelOil para N2O -->
                    <tr>
                        <td class="ColTitle">
                            <asp:Label ID="lblConstFEFuelOilN2O" runat="server" Text="Factor de Emision del FuelOil para N2O:" />
                        </td>
                        <td class="ColContent">
                            <asp:PlaceHolder ID="phConstFEFuelOilN2O" runat="server" />
                        </td>
                        <td class="ColValidator">
                            &nbsp;
                        </td>
