...
{
    public partial class ScriptGasoline : BasePropertiesTask
    {
        ...
        #region Constants
        private RadComboBox _RdcConst_DesidadGasoline;
        private RadTreeView _RtvConstant_DesidadGasoline;
        ...
        private RadComboBox _RdcConst_PCGasoline;
        private RadTreeView _RtvConstant_PCGasoline;
        private RadComboBox _RdcConst_EFGasoline_CO2;
        private RadTreeView _RtvConstant_EFGasoline_CO2;
        private RadComboBox _RdcConst_EFGasoline_CH4;
        private RadTreeView _RtvConstant_EFGasoline_CH4;
        private RadComboBox _RdcConst_EFGasoline_N2O;
        private RadTreeView _RtvConstant_EFGasoline_N2O;
        #endregion
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            AddComboConst_DesidadGasoline();
            AddComboConst_PCG_CH4();
            AddComboConst_PCG_N2O();

            AddComboConst_PCGasoline();
            AddComboConstFEGasoline_CO2();
            AddComboConstFEGasoline_CH4();
            AddComboConstFEGasoline_N2O();
        ...
        {
            base.PageTitle = Resources.CommonListManage.ScriptGasoline;
        }
        ...
        {
            Int64 _idIndicatorGasoline = 288;//Para Demo // 17;//Para Ghree
            Int64 _idNoConditionGasoline = 246;//Para Demo // 17;//Para Ghree
            Int64 _idMagnitud = 42;                                  //42->Volumen
            Int64 _idMeasurementUnit_m3 = 120;                      //120->m3	Cubic Meter

            Indicator _indicator = EMSLibrary.User.PerformanceAssessments.Map.Indicator(_idIndicatorGasoline);

            lblIndicatorValue.Text = Common.Functions.ReplaceIndexesTags(_indicator.LanguageOption.Name);
            lblParameterGroupValue.Text = _indicator.ParameterGroup(_idNoConditionGasoline).LanguageOption.Name;
        ...
        {
            Page.Title = Resources.CommonListManage.ScriptGasoline;
        ...
        private void AddComboConst_DesidadGasoline()
        {
            Dictionary<String, Object> _params = new Dictionary<String, Object>();
            AddComboTreeConstant(ref phConstDesidadGasoline, ref _RdcConst_DesidadGasoline, ref _RtvConstant_DesidadGasoline, new RadTreeViewEventHandler(rtvConst_NodeExpand));
        }
        ...
        private void AddComboConst_PCGasoline()
        {
            Dictionary<String, Object> _params = new Dictionary<String, Object>();
            AddComboTreeConstant(ref phConstPCGasoline, ref _RdcConst_PCGasoline, ref _RtvConstant_PCGasoline, new RadTreeViewEventHandler(rtvConst_NodeExpand));
        }
        private void AddComboConstFEGasoline_CO2()
        {
            Dictionary<String, Object> _params = new Dictionary<String, Object>();
            AddComboTreeConstant(ref phConstFEGasolineCO2, ref _RdcConst_EFGasoline_CO2, ref _RtvConstant_EFGasoline_CO2, new RadTreeViewEventHandler(rtvConst_NodeExpand));
        }
        private void AddComboConstFEGasoline_CH4()
        {
            Dictionary<String, Object> _params = new Dictionary<String, Object>();
            AddComboTreeConstant(ref phConstFEGasolineCH4, ref _RdcConst_EFGasoline_CH4, ref _RtvConstant_EFGasoline_CH4, new RadTreeViewEventHandler(rtvConst_NodeExpand));
        }
        private void AddComboConstFEGasoline_N2O()
        {
            Dictionary<String, Object> _params = new Dictionary<String, Object>();
            AddComboTreeConstant(ref phConstFEGasolineN2O, ref _RdcConst_EFGasoline_N2O, ref _RtvConstant_EFGasoline_N2O, new RadTreeViewEventHandler(rtvConst_NodeExpand));
        }
        ...
        private Dictionary<String, Condesus.EMS.Business.IOperand> BuildOperatorForTransformation1()
        {
            ...
            Int64 _idConstantClass_EFGasoline_CH4 = Convert.ToInt64(GetKeyValue(_RtvConstant_EFGasoline_CH4.SelectedNode.Value, "IdConstantClassification"));
            Int64 _idConstantClass_EFGasoline_N2O = Convert.ToInt64(GetKeyValue(_RtvConstant_EFGasoline_N2O.SelectedNode.Value, "IdConstantClassification"));
            Int64 _idConstantClass_EFGasoline_CO2 = Convert.ToInt64(GetKeyValue(_RtvConstant_EFGasoline_CO2.SelectedNode.Value, "IdConstantClassification"));
            Int64 _idConstantClass_PCGasoline = Convert.ToInt64(GetKeyValue(_RtvConstant_PCGasoline.SelectedNode.Value, "IdConstantClassification"));

            Int64 _idConstant_EFGasoline_CH4 = Convert.ToInt64(GetKeyValue(_RtvConstant_EFGasoline_CH4.SelectedNode.Value, "IdConstant"));
            Int64 _idConstant_EFGasoline_N2O = Convert.ToInt64(GetKeyValue(_RtvConstant_EFGasoline_N2O.SelectedNode.Value, "IdConstant"));
            Int64 _idConstant_EFGasoline_CO2 = Convert.ToInt64(GetKeyValue(_RtvConstant_EFGasoline_CO2.SelectedNode.Value, "IdConstant"));
            Int64 _idConstant_PCGasoline = Convert.ToInt64(GetKeyValue(_RtvConstant_PCGasoline.SelectedNode.Value, "IdConstant"));

            Int64 _idConstantClass_DensidadGasoline = Convert.ToInt64(GetKeyValue(_RtvConstant_DesidadGasoline.SelectedNode.Value, "IdConstantClassification"));
            Int64 _idConstant_DensidadGasoline = Convert.ToInt64(GetKeyValue(_RtvConstant_DesidadGasoline.SelectedNode.Value, "IdConstant")); ;

            _operands.Add("A", EMSLibrary.User.PerformanceAssessments.Configuration.ConstantClassification(_idConstantClass_DensidadGasoline).Constant(_idConstant_DensidadGasoline));
            _operands.Add("B", EMSLibrary.User.PerformanceAssessments.Configuration.ConstantClassification(_idConstantClass_PCGasoline).Constant(_idConstant_PCGasoline));
            _operands.Add("C", EMSLibrary.User.PerformanceAssessments.Configuration.ConstantClassification(_idConstantClass_EFGasoline_CO2).Constant(_idConstant_EFGasoline_CO2));
        ...
        private Dictionary<String, Condesus.EMS.Business.IOperand> BuildOperatorForTransformation4()
        {
            ...
            _operands.Add("A", EMSLibrary.User.PerformanceAssessments.Configuration.ConstantClassification(_idConstantClass_DensidadGasoline).Constant(_idConstant_DensidadGasoline));
            _operands.Add("B", EMSLibrary.User.PerformanceAssessments.Configuration.ConstantClassification(_idConstantClass_PCGasoline).Constant(_idConstant_PCGasoline));
            _operands.Add("C", EMSLibrary.User.PerformanceAssessments.Configuration.ConstantClassification(_idConstantClass_EFGasoline_CH4).Constant(_idConstant_EFGasoline_CH4));
        ...
        private Dictionary<String, Condesus.EMS.Business.IOperand> BuildOperatorForTransformation7()
        {
            ...
            _operands.Add("A", EMSLibrary.User.PerformanceAssessments.Configuration.ConstantClassification(_idConstantClass_DensidadGasoline).Constant(_idConstant_DensidadGasoline));
            _operands.Add("B", EMSLibrary.User.PerformanceAssessments.Configuration.ConstantClassification(_idConstantClass_PCGasoline).Constant(_idConstant_PCGasoline));
            _operands.Add("C", EMSLibrary.User.PerformanceAssessments.Configuration.ConstantClassification(_idConstantClass_EFGasoline_N2O).Constant(_idConstant_EFGasoline_N2O));
            ...
            try
            {
                ...
                using (TransactionScope _transactionScope = new TransactionScope(new TransactionScopeOption(), new TimeSpan(0, 10, 0)))
                {
                    ...
                    foreach (String _item in _SitesAux)
                    {
                        ...
                        ProcessTaskMeasurement _taskMeasurementBase = MeasurementTaskAdd(true, _site, _idIndicatorGasoline, _idNoConditionGasoline, _idMeasurementUnit_m3, _measurementTaskBaseName, txtDescription.Text);
                        #endregion
