...
namespace Condesus.EMS.WebUI.ManagementTools.PerformanceAssessment
{
    public partial class Map : BasePage
    {
        ...
        #region PageLoad & Init
            ...
            {
                _PageTitleLocal = Resources.CommonMenu.MapPAPageTitle;
        ...
        #region Private Method
            ...
            {
                Page.Title = Resources.CommonMenu.MapPAPageTitle;
                lblDescription.Text = Resources.CommonMenu.MapPADescription;
            }
            ...
            private void SecuritySystemJobTitlesNavigate()
            {
                ...
                switch (_SelectedModuleSection)
                {
                    case "Map":
                        ...
                        _entityNameGrid = Common.ConstantsEntitiesName.SS.RightJobTitleMapsPA;
                        _entityName = Common.ConstantsEntitiesName.SS.RightJobTitleMapPA;
                        break;
                    case "Admin":
                        _pkValues = "ParentEntity=" + Condesus.EMS.Business.Common.Security.ConfigurationPA;
                        _pageTitle = _PageTitleLocal + " - " + Resources.Common.RightJobTitle;
                        _entityNameGrid = Common.ConstantsEntitiesName.SS.RightJobTitleConfigurationsPA;
                        _entityName = Common.ConstantsEntitiesName.SS.RightJobTitleConfigurationPA;
                        break;
                }
            ...
            private void SecuritySystemPersonNavigate()
            {
                ...
                switch (_SelectedModuleSection)
                {
                    case "Map":
                        ...
                        _entityNameGrid = Common.ConstantsEntitiesName.SS.RightPersonMapsPA;
                        _entityName = Common.ConstantsEntitiesName.SS.RightPersonMapPA;
                        break;
                    case "Admin":
                        _pkValues = "ParentEntity=" + Condesus.EMS.Business.Common.Security.ConfigurationPA;
                        _pageTitle = _PageTitleLocal + " - " + Resources.Common.RightPerson;
                        _entityNameGrid = Common.ConstantsEntitiesName.SS.RightPersonConfigurationsPA;
                        _entityName = Common.ConstantsEntitiesName.SS.RightPersonConfigurationPA;
                        break;
                }
                base.NavigatorAddPkEntityIdTransferVar("PkCompost", _pkValues);
                base.NavigatorAddTransferVar("PageTitle", _pageTitle);
