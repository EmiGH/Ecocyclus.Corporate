...
namespace Condesus.EMS.WebUI.ManagementTools.KnowledgeCollaboration
{
    public partial class Map : BasePage
    {
        ...
        #region PageLoad & Init
            ...
            {
                _PageTitleLocal = Resources.CommonMenu.MapKCPageTitle;
        ...
        #region Private Method
            ...
            {
                Page.Title = Resources.CommonMenu.MapKCPageTitle;
                lblDescription.Text = Resources.CommonMenu.MapKCDescription;
            }
            ...
            private void SecuritySystemJobTitlesNavigate()
            {
                ...
                switch (_SelectedModuleSection)
                {
                    case "Map":
                        ...
                        _entityNameGrid = Common.ConstantsEntitiesName.SS.RightJobTitleMapsKC;
                        _entityName = Common.ConstantsEntitiesName.SS.RightJobTitleMapKC;
                        break;
                    case "Admin":
                        _pkValues = "ParentEntity=" + Condesus.EMS.Business.Common.Security.ConfigurationKC;
                        _pageTitle = _PageTitleLocal + " - " + Resources.Common.RightJobTitle;
                        _entityNameGrid = Common.ConstantsEntitiesName.SS.RightJobTitleConfigurationsKC;
                        _entityName = Common.ConstantsEntitiesName.SS.RightJobTitleConfigurationKC;
                        break;
                }
            ...
            private void SecuritySystemPersonNavigate()
            {
                ...
                switch (_SelectedModuleSection)
                {
                    case "Map":
                        ...
                        _entityNameGrid = Common.ConstantsEntitiesName.SS.RightPersonMapsKC;
                        _entityName = Common.ConstantsEntitiesName.SS.RightPersonMapKC;
                        break;
                    case "Admin":
                        _pkValues = "ParentEntity=" + Condesus.EMS.Business.Common.Security.ConfigurationKC;
                        _pageTitle = _PageTitleLocal + " - " + Resources.Common.RightPerson;
                        _entityNameGrid = Common.ConstantsEntitiesName.SS.RightPersonConfigurationsKC;
                        _entityName = Common.ConstantsEntitiesName.SS.RightPersonConfigurationKC;
                        break;
                }
                base.NavigatorAddPkEntityIdTransferVar("PkCompost", _pkValues);
                base.NavigatorAddTransferVar("PageTitle", _pageTitle);
