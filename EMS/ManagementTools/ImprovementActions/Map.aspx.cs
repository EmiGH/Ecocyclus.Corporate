...
namespace Condesus.EMS.WebUI.ManagementTools.ImprovementActions
{
    public partial class Map : BasePage
    {
        ...
        #region PageLoad & Init
            ...
            {
                _PageTitleLocal = Resources.CommonMenu.MapIAPageTitle;
        ...
        #region Private Method
            ...
            {
                Page.Title = Resources.CommonMenu.MapIAPageTitle;
                lblDescription.Text = Resources.CommonMenu.MapIADescription;
            }
            ...
            private void SecuritySystemJobTitlesNavigate()
            {
                ...
                switch (_SelectedModuleSection)
                {
                    case "Map":
                        ...
                        _entityNameGrid = Common.ConstantsEntitiesName.SS.RightJobTitleMapsIA;
                        _entityName = Common.ConstantsEntitiesName.SS.RightJobTitleMapIA;
                        break;
                    case "Admin":
                        _pkValues = "ParentEntity=" + Condesus.EMS.Business.Common.Security.ConfigurationIA;
                        _pageTitle = _PageTitleLocal + " - " + Resources.Common.RightJobTitle;
                        _entityNameGrid = Common.ConstantsEntitiesName.SS.RightJobTitleConfigurationsIA;
                        _entityName = Common.ConstantsEntitiesName.SS.RightJobTitleConfigurationIA;
                        break;
                }
            ...
            private void SecuritySystemPersonNavigate()
            {
                ...
                switch (_SelectedModuleSection)
                {
                    case "Map":
                        ...
                        _entityNameGrid = Common.ConstantsEntitiesName.SS.RightPersonMapsIA;
                        _entityName = Common.ConstantsEntitiesName.SS.RightPersonMapIA;
                        break;
                    case "Admin":
                        _pkValues = "ParentEntity=" + Condesus.EMS.Business.Common.Security.ConfigurationIA;
                        _pageTitle = _PageTitleLocal + " - " + Resources.Common.RightPerson;
                        _entityNameGrid = Common.ConstantsEntitiesName.SS.RightPersonConfigurationsIA;
                        _entityName = Common.ConstantsEntitiesName.SS.RightPersonConfigurationIA;
                        break;
                }
                base.NavigatorAddPkEntityIdTransferVar("PkCompost", _pkValues);
                base.NavigatorAddTransferVar("PageTitle", _pageTitle);
