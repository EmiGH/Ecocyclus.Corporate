<%@ Page Language="C#" MasterPageFile="~/EMS.Master" AutoEventWireup="true" CodeBehind="ProcessGroupNodeExceptionProperties.aspx.cs"
    Inherits="Condesus.EMS.WebUI.ManagementTools.ProcessesMap.ProcessGroupNodeExceptionProperties"
    Title="EMS - Process Group Node Exception Properties" Culture="auto" UICulture="auto" meta:resourcekey="PageResource1" %>
                ...
                <table id="tblContentForm" runat="server" class="ContentForm">
                    ...
                    <tr>
                        <td class="ColTitle">
                            ...
                            Text="Parent Process:" meta:resourcekey="lblIdParentResource1" />
                        </td>
                        <td class="ColContent">
                    ...
                    <tr>
                        <td class="ColTitle">
                            ...
                            Text="Id Node:" meta:resourcekey="lblIDResource1" />
                    ...
                    <tr>
                        ...
                        <td class="ColContent">
                            ...
                            SkinID="EMS" meta:resourcekey="txtTitleResource1"></asp:TextBox>
                        </td>
                        <td class="ColValidator">
                    ...
                    <tr>
                        ...
                        <td class="ColContent">
                            <asp:TextBox ID="txtDescription"  Rows="6" runat="server" MaxLength="8000"
                            TextMode="MultiLine" 
