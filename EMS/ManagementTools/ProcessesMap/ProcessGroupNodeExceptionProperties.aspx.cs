...
{
    public partial class ProcessGroupNodeExceptionProperties : BasePM
    {
        //#region Internal Properties
        //    private Int64 IdProcessClassification
        //    {
        //        get { return Convert.ToInt64(ViewState["IdProcessClassification"]); }
        //        set { ViewState["IdProcessClassification"] = value.ToString(); }
        //    }
        ...
        //        lblIdParentValue.Text = IdParentProcess.ToString();
        ...
        //{
        //    Condesus.EMS.Business.PF.Entities.ProcessGroupNode _process = (Condesus.EMS.Business.PF.Entities.ProcessGroupNode)EMSLibrary.User.ProcessFramework.Map.Process(IdProcess);
        ...
        //{
        //    String[,] _param = new String[,] { { "IdProcess", IdProcess.ToString() }, { "ItemOptionSelected", ItemOptionSelected.ToString() }, { "IdProcessClassification", IdProcessClassification.ToString() }, { "IdParentProcess", IdParentProcess.ToString() } };
        ...
        //        if (IdProcess == 0)
        //        {
        //            //Condesus.EMS.Business.PF.Entities.ProcessGroupException _processGroupException = (Condesus.EMS.Business.PF.Entities.ProcessGroupException)EMSLibrary.User.ProcessFramework.Map.Process(IdParentProcess);
        //            Condesus.EMS.Business.PF.Entities.ProcessGroupNode _processNodeException = null;
        //            Condesus.EMS.Business.PF.Entities.Process _process = (Condesus.EMS.Business.PF.Entities.Process)EMSLibrary.User.ProcessFramework.Map.Process(IdParentProcess);
                    
        //            if(_process is Condesus.EMS.Business.PF.Entities.ProcessGroupException)
        //                _processNodeException = ((Condesus.EMS.Business.PF.Entities.ProcessGroupException)_process).AddNode(Convert.ToInt16(txtWeight.Text), 6666, txtTitle.Text, txtPurpose.Text, txtDescription.Text, Convert.ToInt16(TxtThreshold.Text));;
        //            if(_process is Condesus.EMS.Business.PF.Entities.ProcessGroupNode)
        //                _processNodeException = ((Condesus.EMS.Business.PF.Entities.ProcessGroupNode)_process).AddNode(Convert.ToInt16(txtWeight.Text), 6666, txtTitle.Text, txtPurpose.Text, txtDescription.Text, Convert.ToInt16(TxtThreshold.Text)); ;

        //            if (_processNodeException == null)
        //                throw new Exception("The supplied Parent isnt a supported Process Type.");

        //            lblIdValue.Text = _processNodeException.IdProcess.ToString();
        //            IdProcess = _processNodeException.IdProcess;
        //        }
        //        else
        //        {
        //            Condesus.EMS.Business.PF.Entities.ProcessGroupNode _processNodeException = ((Condesus.EMS.Business.PF.Entities.ProcessGroupNode)EMSLibrary.User.ProcessFramework.Map.Process(IdProcess));
        //            ((Condesus.EMS.Business.PF.Entities.ProcessGroupNode)EMSLibrary.User.ProcessFramework.Map.Process(IdProcess)).Modify(Convert.ToInt16(txtWeight.Text), 6666, txtTitle.Text, txtPurpose.Text, txtDescription.Text, Convert.ToInt16(TxtThreshold.Text), _processNodeException.Parent);
        ...
        //        try
        //        {
        //            //EMSLibrary.User.DirectoryServices.Map.Organization(IdOrganization).ProcessClassification(IdProcessClassification).ProcessGroupRootClassificationRemove(IdProcess);
        //            Condesus.EMS.Business.PF.Entities.ProcessGroupNode _processGroupNode = (Condesus.EMS.Business.PF.Entities.ProcessGroupNode)EMSLibrary.User.ProcessFramework.Map.Process(IdProcess);
        //            ((Condesus.EMS.Business.PF.Entities.ProcessGroup)EMSLibrary.User.ProcessFramework.Map.Process(IdParentProcess)).Remove(_processGroupNode);
