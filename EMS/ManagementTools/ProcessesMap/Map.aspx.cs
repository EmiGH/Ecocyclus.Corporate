...
namespace Condesus.EMS.WebUI.ManagementTools.ProcessesMap
{
    public partial class Map : BasePage
    {
        ...
        #region PageLoad & Init
            ...
            {
                _PageTitleLocal = Resources.CommonMenu.MapPFPageTitle;
        ...
        #region Private Method
            ...
            {
                Page.Title = Resources.CommonMenu.MapPFPageTitle;
                lblDescription.Text = Resources.CommonMenu.MapPFDescription;
            }
            ...
            private void SecuritySystemJobTitlesNavigate()
            {
                ...
                switch (_SelectedModuleSection)
                {
                    case "Map":
                        ...
                        _entityNameGrid = Common.ConstantsEntitiesName.SS.RightJobTitleMapsPF;
                        _entityName = Common.ConstantsEntitiesName.SS.RightJobTitleMapPF;
                        break;
                    case "Admin":
            ...
            private void SecuritySystemPersonNavigate()
            {
                ...
                switch (_SelectedModuleSection)
                {
                    case "Map":
                        ...
                        _entityNameGrid = Common.ConstantsEntitiesName.SS.RightPersonMapsPF;
                        _entityName = Common.ConstantsEntitiesName.SS.RightPersonMapPF;
                        break;
                    case "Admin":
                        _pkValues = "ParentEntity=" + Condesus.EMS.Business.Common.Security.ConfigurationPF;
                        _pageTitle = _PageTitleLocal + " - " + Resources.Common.RightPerson;
