<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/EMS.Master" CodeBehind="Default.aspx.cs"
    Inherits="Condesus.EMS.WebUI.PA.Default" %>
...
<asp:Content ID="cntContent" ContentPlaceHolderID="ContentMain" runat="server">
    <div class="content">
        ...
        <div class="contentdivContainerIconsTitle">
            <div class="contentdivContainerTitleIconPA">
            </div>
            <div class="contentdivContainerTitle">
                <asp:Label ID="lblTitle" CssClass="contentdivContainerDefaultTitle" runat="server"
                    Text="" />
            </div>
            <asp:Label CssClass="contentdivContainerDefaultSubTitle" ID="lblSubTitle" runat="server"
                Text="" />
        </div>
        ...
        <asp:Label runat="server" ID="lblTitleDescription" CssClass="contentdivDefaultTitleDescription"
            Text=""></asp:Label>
        <asp:Label runat="server" ID="lblDescription" CssClass="contentdivDefaultDescription"
            Text=""></asp:Label>
    </div>
</asp:Content>
