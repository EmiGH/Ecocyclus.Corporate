    ...
    public partial class FilterRptCalculationsOfTransformation : BaseProperties
    {
        ...
        #region Private Methods
            ...
            protected void InjectShowReportCalculation(Int64 idProcess, String dtStartDate, String dtEndDate, String reportType)
            {
                ...
                _sbBuffer.Append("          var newWindow = window.open(" + Convert.ToChar(34) + "http://" +Request.ServerVariables["HTTP_HOST"].ToString() + (!string.IsNullOrEmpty(Request.ApplicationPath) ? Request.ApplicationPath : "") + "/Dashboard/ReportCalculationsOfTransformation.aspx?ReportType=" + Convert.ToChar(34) + " + _reportType + '&Report=' + _report + '&IdProcess=' + _idProcess + '&StartDate=' + _startDate + '&EndDate=' + _endDate, 'Reports', 'toolbar=yes,location=yes,resizable=yes,status=yes,menubar=yes,scrollbars=yes');      \n");
                _sbBuffer.Append("      }                                                                                           \n");
