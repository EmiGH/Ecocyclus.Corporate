    ...
    public partial class FilterListEmissionsByFacility : BaseProperties
    {
        ...
        #region Private Methods
            ...
            protected void InjectShowReportCalculation(Int64 idProcess, String dtStartDate, String dtEndDate)
            {
                ...
                _sbBuffer.Append("          var newWindow = window.open(" + Convert.ToChar(34) + "http://" + Request.ServerVariables["HTTP_HOST"].ToString() + "/Managers/ListEmissionsByFacility.aspx?IdProcess=" + Convert.ToChar(34) + " + _idProcess + '&StartDate=' + _startDate + '&EndDate=' + _endDate, 'Reports', 'toolbar=yes,location=yes,resizable=yes,status=yes,menubar=yes,scrollbars=yes');      \n");
                _sbBuffer.Append("      }                                                                                           \n");
                _sbBuffer.Append("      else                                                                                        \n");
                _sbBuffer.Append("      {   //FireFox                                                                               \n");
                _sbBuffer.Append("          var newWindow = window.parent.open(" + Convert.ToChar(34) + "http://" + Request.ServerVariables["HTTP_HOST"].ToString() + "/Managers/ListEmissionsByFacility.aspx?IdProcess=" + Convert.ToChar(34) + " + _idProcess + '&StartDate=' + _startDate + '&EndDate=' + _endDate, 'Reports', 'toolbar=yes,location=yes,resizable=yes,status=yes,menubar=yes,scrollbars=yes');      \n");
                _sbBuffer.Append("      }                                                                                           \n");
