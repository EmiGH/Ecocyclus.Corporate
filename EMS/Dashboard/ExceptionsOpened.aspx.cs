...
{
    public partial class ExceptionsOpened : BasePage
    {
        ...
        #region Generic Method
            private DataTable LoadGrid()
            {
                ...
                //Dictionary<Int64, Condesus.EMS.Business.IA.Entities.Exception> _exceptions = EMSLibrary.User.DirectoryServices.Map.Organization(IdOrganization).Dashboard.ProcessExceptionOpen;
