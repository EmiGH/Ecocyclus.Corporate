...
namespace Condesus.EMS.WebUI.Dashboard
{
    ...
    public partial class BaseDashboard : BasePage
    {
        ...
        protected void InjectShowReportProjectSummary()
        {
            ...
            _sbBuffer.Append("      var newWindow = window.open(" + Convert.ToChar(34) + "http://" + Request.ServerVariables["HTTP_HOST"].ToString() + "/Reports/ProjectReports.aspx?IdProject=" + Convert.ToChar(34) + " + idProject, 'Reports', 'toolbar=yes,location=yes,resizable=yes,status=yes,menubar=yes,scrollbars=yes');      \n");
            _sbBuffer.Append("  }                                                                                           \n");
            _sbBuffer.Append("  else                                                                                        \n");
            _sbBuffer.Append("  {   //FireFox                                                                               \n");
            _sbBuffer.Append("      var newWindow = window.parent.open(" + Convert.ToChar(34) + "http://" + Request.ServerVariables["HTTP_HOST"].ToString() + "/Reports/ProjectReports.aspx?IdProject=" + Convert.ToChar(34) + " + idProject, 'Reports', 'toolbar=yes,location=yes,resizable=yes,status=yes,menubar=yes,scrollbars=yes');      \n");
            _sbBuffer.Append("  }                                                                                           \n");
            //_sbBuffer.Append("  var newWindow = window.open(" + Convert.ToChar(34) + "http://" + Request.ServerVariables["HTTP_HOST"].ToString() + "/Reports/ProjectReports.aspx?IdProject=" + Convert.ToChar(34) + " + idProject, 'Reports', 'toolbar=yes,location=yes,resizable=yes,status=yes,menubar=yes,scrollbars=yes');                     \n");
