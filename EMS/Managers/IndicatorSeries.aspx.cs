...
namespace Condesus.EMS.WebUI.Managers
{
    public partial class IndicatorSeries : BasePage
    {
        #region Properties
            ...
            private Int64 _IdMeasurementView
            {
                get
                {
                    Object o = ViewState["IdMeasurementView"];
                    if (o != null)
                    {
                        return Convert.ToInt64(ViewState["IdMeasurementView"]);
                    }
                    else
                    {
                        ViewState["IdMeasurementView"] = _IdMeasurement;
                        return Convert.ToInt64(ViewState["IdMeasurementView"]);
                    }
                }
                set
                {
                    ViewState["IdMeasurementView"] = value;
                }
            }
            private Int64 _IdTransformationView
            {
                get
                {
                    Object o = ViewState["IdTransformationView"];
                    if (o != null)
                    {
                        return Convert.ToInt64(ViewState["IdTransformationView"]);
                    }
                    else
                    {
                        ViewState["IdTransformationView"] = 0;
                        return Convert.ToInt64(ViewState["IdTransformationView"]);
                    }
                }
                set
                {
                    ViewState["IdTransformationView"] = value;
                }
            }
        #endregion
        ...
        #region Load Information
            protected override void OnInit(EventArgs e)
            {
                ...
                lnkExport.OnClientClick = "return ExportMeasurementSeries(this, " + _IdMeasurementView + ", " + _IdTransformationView + ");";
            }
            ...
            protected override void SetPagetitle()
            {
                try
                {
                    base.PageTitle = Resources.CommonListManage.IndicatorSeries;
                }
                catch { base.PageTitle = String.Empty; }
            }
            protected override void SetPageTileSubTitle()
            {
                base.PageTitleSubTitle = Resources.CommonListManage.IndicatorSeriesSubTitle;
            }
        #endregion
        ...
        #region Private Methods
            private void LoadData()
            {
                ...
                {
                    lblParameterValue.Text = _item.LanguageOption.Name + "<br/>";   // _measurement.ParameterGroup.LanguageOption.Name;
                }
            ...
            private DataTable ReturnDataGrid()
            {
                ...
                //Measurement _measurement = EMSLibrary.User.PerformanceAssessments.Configuration.Measurement(_IdMeasurementView);
                ...
                {
                    CalculateOfTransformation _calculateOfTransformation = EMSLibrary.User.PerformanceAssessments.Configuration.Measurement(_IdMeasurementView).Transformation(_IdTransformationView);
                ...
                Int64 idMeasurement, Int64 idTask, Int64 idTransformation, Int64 idConstantClassification, Int64 idConstant, String rowType)
            {
                ...
                String _text = title.IndexOf(" = ") > 0 ? title.Substring(title.IndexOf(" = ") + 3) : title;

                _keyValues = "Title=" + _text
                ...
                switch (rowType)
                {
                    case Common.ConstantsEntitiesName.PA.Measurement:
                        _tr.Attributes["class"] = _tr.Attributes["class"] + " trMeasurement";
                        break;
                    case Common.ConstantsEntitiesName.PA.Transformation:
                        _tr.Attributes["class"] = _tr.Attributes["class"] + " trTransformation";
                        break;
                    case Common.ConstantsEntitiesName.PA.Constant:
                        _tr.Attributes["class"] = _tr.Attributes["class"] + " trConstant";
                        break;
                }
            ...
            private void LoadTreeList()
            {
                ...
                //Condesus.EMS.Business.PA.Entities.MeasurementStatistics _measurementPoint = _measurement.Statistics(_startDate, _endDate);
                ...
                if (_measurementPoint != null)
                {
                    ...
                    if (_measurement.GetType().Name == Common.ConstantsEntitiesName.PA.MeasurementExtensive)
                    {
                        ...
                        //_period = _measurementPoint.FirstDate.ToShortDateString() + " - " + _measurementPoint.LastDate.ToShortDateString();
                    }
                    else
                    {
                ...
                foreach (Condesus.EMS.Business.PA.Entities.CalculateOfTransformation _item in _measurement.Transformations.Values)
                {
                    ...
                    {
                        _measureValue2 = _measurementPointTransformation.MeasureValue;
                    ...
                    AddTableRow(_id, _idTransformationParent,
                        ...
                        _item.Formula,
                        Common.Functions.CustomEMSRound(_measureValue2),
                ...
                foreach (KeyValuePair<String, Condesus.EMS.Business.PA.Entities.CalculateOfTransformationParameter> _item in transformation.Parameters)
                {
                    ...
                    switch (_item.Value.Operand.GetType().Name)
                    {
                        ...
                        case Common.ConstantsEntitiesName.PA.CalculateOfTransformation:
                            ...
                            MeasurementPoint _measurementPointTransformation = _calculateOfTransformation.TotalMeasurement(ref _firsDateSeries);
                            if (_measurementPointTransformation != null)
                            {
                            ...
                            //Primero inserta el texto en el arbol para que se vea
                            AddTableRow(id, idTransformationParent,
                                _idLetter + " = " + Common.Functions.ReplaceIndexesTags(_operandName),
                                Common.Functions.ReplaceIndexesTags(_calculateOfTransformation.Indicator.LanguageOption.Name),
                                Common.Functions.ReplaceIndexesTags(_calculateOfTransformation.Activity.LanguageOption.Name),
                                ...
                                "-",
                                _period,
                                _calculateOfTransformation.MeasurementOrigin.IdMeasurement,
                            ...
                            id++;
                            //Arma el string que muestra el listBox y el KeyValue, para el dictionary interno
                            LoadParameters(_idLetter + " = ", _calculateOfTransformation, ref id, _idParent);
        ...
        #region Page Events
            protected void _img_ServerClick(object sender, ImageClickEventArgs e)
            {
                ...
                _IdMeasurementView = Convert.ToInt64(GetKeyValue(_keyValues, "IdMeasurement"));
                _IdTransformationView = Convert.ToInt64(GetKeyValue(_keyValues, "IdTransformation"));

                //_IdMeasurementView = _idMeasurement;
                lnkExport.OnClientClick = "return ExportMeasurementSeries(this, " + _IdMeasurementView + ", " + _IdTransformationView + ");";
            ...
            #region RGDMasterGrid
                ...
                //protected void lnkExportGridSeries_Click(object sender, EventArgs e)
                //{
                //    //pchControls.Controls.Clear();

                //    //InitializeGrid();
                //    //rgdMasterGrid.DataSource = ReturnDataGrid();
                //    ////rgdMasterGrid.Rebind();

                //    //ConfigureExport(rgdMasterGrid);

                //    //rgdMasterGrid.MasterTableView.ExportToExcel();  


                //    //DataTable toExcel = ReturnDataGrid().Copy();
                ...
                //    //context.Response.AppendHeader("Content-Disposition", "attachment; filename=MeasurementSeries.csv");
                //    //context.Response.End();

                //    String _path = Server.MapPath("~/Export");
                //    ExportarExcelDataTable(ReturnDataGrid(), _path + "/MeasurementSeries.xls");

                //    ShowExport("/MeasurementSeries.xls");
                //}
                ...
                //    sw.Close();
                //}
                //private void ShowExport(String fileNameExport)
                //{
                //    String[] _files;
                //    String _path = Server.MapPath("~/Export");
                //    String _filePathName = _path + "\\" + fileNameExport;
                ...
                //    Response.AddHeader("Content-Disposition", "filename=" + fileNameExport);
