...
namespace Condesus.EMS.WebUI
{
    public partial class BasePage : System.Web.UI.Page
    {
        ...
        protected void InjectShowFile(String gridClientId)
        {
            ...
            _sbBuffer.Append("          if (_BrowserName == _IEXPLORER)                                                             \n");
            _sbBuffer.Append("          {   //IE and Opera                                                                          \n");
            _sbBuffer.Append("              var newWindow = window.open('http://" + Request.ServerVariables["HTTP_HOST"].ToString() + (!string.IsNullOrEmpty(Request.ApplicationPath) ? Request.ApplicationPath : "") + "/ManagementTools/KnowledgeCollaboration/FilesViewer.aspx?IdResource=' + idResource + '&IdResourceFile=' + idResourceFile, 'Reports', 'toolbar=yes,location=yes,resizable=yes,status=yes,menubar=yes,scrollbars=yes');      \n");
            _sbBuffer.Append("          }                                                                                           \n");
            _sbBuffer.Append("          else                                                                                        \n");
            _sbBuffer.Append("          {   //FireFox                                                                               \n");
            _sbBuffer.Append("              var newWindow = window.parent.open('http://" + Request.ServerVariables["HTTP_HOST"].ToString() + (!string.IsNullOrEmpty(Request.ApplicationPath) ? Request.ApplicationPath : "") +"/ManagementTools/KnowledgeCollaboration/FilesViewer.aspx?IdResource=' + idResource + '&IdResourceFile=' + idResourceFile, 'Reports', 'toolbar=yes,location=yes,resizable=yes,status=yes,menubar=yes,scrollbars=yes');      \n");
            _sbBuffer.Append("          }                                                                                           \n");
