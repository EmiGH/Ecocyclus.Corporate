...
{
    public class ConfigurationPF : ISecurity
    {
        #region Internal Properties
        private Credential _Credential;
        #endregion

        internal ConfigurationPF(Credential credential)
        {
        ...
        #region TimeUnit
        public Dictionary<Int64, PF.Entities.TimeUnit> TimeUnits()
        {
            ...
            return new PF.Collections.TimeUnits(_Credential).Items();
        }
        public PF.Entities.TimeUnit TimeUnit(Int64 idTimeUnit)
        {
            //Realiza las validaciones de autorizacion 
            new Security.Authority(_Credential).Authorize(this.ClassName, this.IdObject, _Credential.User.IdPerson, Common.Permissions.View);
            return new PF.Collections.TimeUnits(_Credential).Item(idTimeUnit);
        }
        #endregion

        #region ParticipationTypes
        public Dictionary<Int64, PF.Entities.ParticipationType> ParticipationTypes()
        {
            //Realiza las validaciones de autorizacion 
            new Security.Authority(_Credential).Authorize(this.ClassName, this.IdObject, _Credential.User.IdPerson, Common.Permissions.View);
            return new PF.Collections.ParticipationTypes(_Credential).Items();
        }
        public PF.Entities.ParticipationType ParticipationType(Int64 idParticipationType)
        {
            //Realiza las validaciones de autorizacion 
            new Security.Authority(_Credential).Authorize(this.ClassName, this.IdObject, _Credential.User.IdPerson, Common.Permissions.View);
            return new PF.Collections.ParticipationTypes(_Credential).Item(idParticipationType);
        }
        public PF.Entities.ParticipationType ParticipationTypeAdd(String name)
        {
            //Realiza las validaciones de autorizacion 
            ...
            return new PF.Collections.ParticipationTypes(_Credential).Add(name);
        }
        public void ParticipationTypeRemove(Int64 idParticipationType)
        {
            //Realiza las validaciones de autorizacion 
            new Security.Authority(_Credential).Authorize(this.ClassName, this.IdObject, _Credential.User.IdPerson, Common.Permissions.Manage);
            new PF.Collections.ParticipationTypes(_Credential).Remove(idParticipationType);
        }
        #endregion        
        ...
        public String ClassName
        {
            get
            {
                return Common.Security.ConfigurationPF;
            }
        }
        #endregion
