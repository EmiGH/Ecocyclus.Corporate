...
{
    public class ConfigurationKC : ISecurity
    {
        #region Internal Properties
        private Credential _Credential;
        #endregion

        internal ConfigurationKC(Credential credential)
        {
            _Credential = credential;
        }

        #region ResourceTypes
        public Dictionary<Int64, KC.Entities.ResourceType> ResourceTypes()
        {
            ...
            return new KC.Collections.ResourceTypes(_Credential).Items();
        }
        public KC.Entities.ResourceType ResourceType(Int64 idResourceType)
        {
            //Realiza las validaciones de autorizacion 
            //new Security.Authority(_Credential).Authorize(this.ClassName, this.IdObject, _Credential.User.IdPerson, Common.Permissions.View);
            return new KC.Collections.ResourceTypes(_Credential).Item(idResourceType);
        }
        public KC.Entities.ResourceType ResourceTypeAdd(Int64 idParent, String name, String description)
        {
            //Realiza las validaciones de autorizacion 
            ...
            return new KC.Collections.ResourceTypes(_Credential, idParent).Add(name, description);
        }
        public void ResourceTypeRemove(ResourceType resourceType)
        {
            //Realiza las validaciones de autorizacion 
            //new Security.Authority(_Credential).Authorize(this.ClassName, this.IdObject, _Credential.User.IdPerson, Common.Permissions.Manage);
            new KC.Collections.ResourceTypes(_Credential).Remove(resourceType);
        }
        #endregion

        #region ResourceFileStates
        public Dictionary<Int64, KC.Entities.ResourceHistoryState> ResourceHistoryStates()
        {
            //Realiza las validaciones de autorizacion 
            //new Security.Authority(_Credential).Authorize(this.ClassName, this.IdObject, _Credential.User.IdPerson, Common.Permissions.View);
            return new KC.Collections.ResourceHistoryStates(_Credential).Items();
        }
        public KC.Entities.ResourceHistoryState ResourceHistoryState(Int64 idResourceFileState)
        {
            //Realiza las validaciones de autorizacion 
            //new Security.Authority(_Credential).Authorize(this.ClassName, this.IdObject, _Credential.User.IdPerson, Common.Permissions.View);
            return new KC.Collections.ResourceHistoryStates(_Credential).Item(idResourceFileState);
        }
        public KC.Entities.ResourceHistoryState ResourceHistoryStateAdd(String name, String description)
        {
            //Realiza las validaciones de autorizacion 
            //new Security.Authority(_Credential).Authorize(this.ClassName, this.IdObject, _Credential.User.IdPerson, Common.Permissions.Manage);
            return new KC.Collections.ResourceHistoryStates(_Credential).Add(name, description);
        }
        public void ResourceHistoryStateRemove(Int64 idResourceFileState)
        {
            //Realiza las validaciones de autorizacion 
            //new Security.Authority(_Credential).Authorize(this.ClassName, this.IdObject, _Credential.User.IdPerson, Common.Permissions.Manage);
            new KC.Collections.ResourceHistoryStates(_Credential).Remove(idResourceFileState);
        }
        #endregion
        ...
        public String ClassName
        {
            get
            {
                return Common.Security.ConfigurationKC;
            }
        }
        #endregion
