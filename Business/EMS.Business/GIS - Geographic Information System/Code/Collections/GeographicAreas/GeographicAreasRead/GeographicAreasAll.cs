...
{
    internal class GeographicAreasAll : ICollectionItems
    {
        private Credential _Credential;

        internal GeographicAreasAll(Credential credential)
        {
        ...
        public IEnumerable<System.Data.Common.DbDataRecord> getItems()
        {
            ...
            return _dbGeographicInformationSystem.GeographicAreas_ReadAll(_Credential.CurrentLanguage.IdLanguage);
        }
