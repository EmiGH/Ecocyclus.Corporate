...
{
    public class Report_GA_FT_F_S_A_COL
    {
        ...
        internal Report_GA_FT_F_S_A_COL(Entities.Report_GA_FT_F_S_A report_GA_FT_F_S_A, Int64 idIndicatortCO2e, Int64 idIndicatorCO2, Int64 idIndicatorCH4, Int64 idIndicatortnN2O,
                  ...
                  DateTime startDate, DateTime endDate)
        {
            ...
            _EndDate = endDate;
            _Credential = report_GA_FT_F_S_A.Credential;
            _ProcessGroupProcess = report_GA_FT_F_S_A.ProcessGroupProcess;
        }
        ...
        internal List<IColumnsReport> GAs()
        {
            ...
            for (int i = 0; i < _dataRow.Length; i++)
            {
                ...
                Entities.Report_GA_FT_F_S_A_Obj_GA _ga = new Entities.Report_GA_FT_F_S_A_Obj_GA
        ...
        internal List<IColumnsReport> GAs(Entities.Report_GA_FT_F_S_A_Obj_GA ga)
        {
            List<IColumnsReport> _oItems = new List<IColumnsReport>();
        ...
        internal List<IColumnsReport> Ss(Entities.Report_GA_FT_F_S_A_Obj_F f)
        {
            List<IColumnsReport> _oItems = new List<IColumnsReport>();
                ...
                foreach (PA.Entities.AccountingScope _scope in Scopes.Values)
                {
                    ...
                    Entities.Report_GA_FT_F_S_A_Obj_S _s = new Entities.Report_GA_FT_F_S_A_Obj_S(_scope.IdScope, _scope.LanguageOption.Name, f);
        ...
        internal List<IColumnsReport> As(Entities.Report_GA_FT_F_S_A_Obj_S s)
        {
            List<IColumnsReport> _oItems = new List<IColumnsReport>();
                ...
                {
                    //Declara e instancia una posicion
                    Entities.Report_GA_FT_F_S_A_Obj_A _a = new Entities.Report_GA_FT_F_S_A_Obj_A
        ...
        internal List<IColumnsReport> As(Entities.Report_GA_FT_F_S_A_Obj_A a)
        {
            List<IColumnsReport> _oItems = new List<IColumnsReport>();
        ...
        internal List<IColumnsReport> FTs(Entities.Report_GA_FT_F_S_A_Obj_GA a)
        {
            List<IColumnsReport> _oItems = new List<IColumnsReport>();
                ...
                {                    
                    //Declara e instancia una posicion
                    Entities.Report_GA_FT_F_S_A_Obj_FT _ft = new Entities.Report_GA_FT_F_S_A_Obj_FT
        ...
        internal List<IColumnsReport> Fs(Entities.Report_GA_FT_F_S_A_Obj_FT ft)
        {
            List<IColumnsReport> _oItems = new List<IColumnsReport>();
            //Objeto de data layer para acceder a datos
            DataAccess.RG.ReportGraphic _dbReportGraphic = new Condesus.EMS.DataAccess.RG.ReportGraphic();
            ...
            //filtra el datatable
            DataRow[] _dataRow = DTResults.Select("IdFacilityType = " + ft.Id.ToString() + " and IdGeographicArea= " + ft.GA.Id.ToString());
            ...
            foreach (Int64 _idFacility in _listFacilities)
            {
                ...
                Entities.Report_GA_FT_F_S_A_Obj_F _f = new Entities.Report_GA_FT_F_S_A_Obj_F
                                                    (_idFacility,
        ...
        internal List<IColumnsReport> Is(Entities.Report_GA_FT_F_S_A_Obj_A a)
        {
            List<IColumnsReport> _oItems = new List<IColumnsReport>();
            ...
            {
                //Declara e instancia una posicion
                Entities.Report_GA_FT_F_S_A_Obj_I _i = new Entities.Report_GA_FT_F_S_A_Obj_I
                    (Convert.ToInt64(_dataRow[i]["Id"]), _dataRow[i]["Name"].ToString(), a);
        ...
        internal void Results_I(Entities.Report_GA_FT_F_S_A_Obj_I i)
        {
            DataTable _result = DTResults;

            DataRow[] _dataRowResult = _result.Select("IdIndicator= " + i.Id.ToString() + " and IdGeographicArea = " + i.A.S.F.FT.GA.Id.ToString() + " and IdScope= " + i.A.S.Id.ToString() +
                                                    " and IdActivity= " + i.A.Id.ToString() + " and IdFacilityType = " + i.A.S.F.FT.Id.ToString() +
                                                    " and IdFacility= " + i.A.S.F.Id.ToString());
