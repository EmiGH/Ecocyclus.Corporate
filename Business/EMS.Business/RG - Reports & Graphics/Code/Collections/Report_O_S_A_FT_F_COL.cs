...
{
    public class Report_O_S_A_FT_F_COL
    {
        ...
        private Dictionary<Int64, Exist_O> _Exist_Os;
        ...
        internal Report_O_S_A_FT_F_COL(Entities.Report_O_S_A_FT_F report_O_S_A_FT_F, Int64 idIndicatortCO2e, Int64 idIndicatorCO2, Int64 idIndicatorCH4, Int64 idIndicatortnN2O,
                  ...
                  DateTime startDate, DateTime endDate)
        {
            ...
            _EndDate = endDate;
            _Credential = report_O_S_A_FT_F.Credential;
            _ProcessGroupProcess = report_O_S_A_FT_F.ProcessGroupProcess;
        }

        #region O
        private DataTable _AllO;

        internal DataTable AllO
        {
            get
            {
                if (_AllO == null)
        ...
        internal DataTable BuildAllO()
        {
            ...
            IEnumerable<System.Data.Common.DbDataRecord> _record = _dbReportGraphic.Read_All_O(_ProcessGroupProcess.IdProcess);

            foreach (System.Data.Common.DbDataRecord _dbRecord in _record)
            {
                _AllO.Rows.Add(Convert.ToInt64(_dbRecord["IdOrganization"]), Convert.ToString(_dbRecord["Name"]));
            }

            return _AllO;
        }

        internal List<IColumnsReport> Os()
        {
            List<IColumnsReport> _oItems = new List<IColumnsReport>();

            DataTable _allO = AllO;

            DataRow[] _dataRow = _allO.Select("Id > 0"); //Quiero todos

            for (int i = 0; i < _dataRow.Length; i++)
            {

                Entities.Report_O_S_A_FT_F_Obj_O _o = new Entities.Report_O_S_A_FT_F_Obj_O
                  (Convert.ToInt64(_dataRow[i]["Id"]), _dataRow[i]["Name"].ToString(), this);
        ...
        internal List<IColumnsReport> Ss(Entities.Report_O_S_A_FT_F_Obj_O o)
        {
            List<IColumnsReport> _oItems = new List<IColumnsReport>();
                ...
                foreach (PA.Entities.AccountingScope _scope in Scopes.Values)
                {
                    ...
                    Entities.Report_O_S_A_FT_F_Obj_S _s = new Entities.Report_O_S_A_FT_F_Obj_S(_scope.IdScope, _scope.LanguageOption.Name, o);
        ...
        internal List<IColumnsReport> As(Entities.Report_O_S_A_FT_F_Obj_S s)
        {
            List<IColumnsReport> _oItems = new List<IColumnsReport>();
                ...
                {
                    //Declara e instancia una posicion
                    Entities.Report_O_S_A_FT_F_Obj_A _a = new Entities.Report_O_S_A_FT_F_Obj_A
        ...
        internal List<IColumnsReport> As(Entities.Report_O_S_A_FT_F_Obj_A a)
        {
            List<IColumnsReport> _oItems = new List<IColumnsReport>();
                ...
                for (int i = 0; i < _dataRow.Length; i++)
                {
                    //Declara e instancia una posicion
                    Entities.Report_O_S_A_FT_F_Obj_A _a = new Entities.Report_O_S_A_FT_F_Obj_A
                        (Convert.ToInt64(_dataRow[i]["Id"]), _dataRow[i]["Name"].ToString(), a.S);
        ...
        internal List<IColumnsReport> FTs(Entities.Report_O_S_A_FT_F_Obj_A a)
        {
            List<IColumnsReport> _oItems = new List<IColumnsReport>();
                ...
                {                    
                    //Declara e instancia una posicion
                    Entities.Report_O_S_A_FT_F_Obj_FT _ft = new Entities.Report_O_S_A_FT_F_Obj_FT
                    (_facilitytype.IdFacilityType, _facilitytype.LanguageOption.Name,a);

                    if (_ft.Items().Count != 0)
                    {
                        _oItems.Add(_ft);
                    }
        ...
        internal List<IColumnsReport> Fs(Entities.Report_O_S_A_FT_F_Obj_FT ft)
        {
            List<IColumnsReport> _oItems = new List<IColumnsReport>();
            //Objeto de data layer para acceder a datos
            DataAccess.RG.ReportGraphic _dbReportGraphic = new Condesus.EMS.DataAccess.RG.ReportGraphic();
            ...
            //filtra el datatable
            DataRow[] _dataRow = DTResults.Select("IdFacilityType = " + ft.Id.ToString() + " and IdActivity= " + ft.A.Id.ToString() + " and IdOrganization= " + ft.A.S.O.Id.ToString() + " and IdScope= " + ft.A.S.Id.ToString());
            ...
            foreach (Int64 _idFacility in _listFacilities)
            {
                ...
                Entities.Report_O_S_A_FT_F_Obj_F _f = new Entities.Report_O_S_A_FT_F_Obj_F
                                                    (_idFacility,
        ...
        internal List<IColumnsReport> Is(Entities.Report_O_S_A_FT_F_Obj_F f)
        {
            List<IColumnsReport> _oItems = new List<IColumnsReport>();
            ...
            {
                //Declara e instancia una posicion
                Entities.Report_O_S_A_FT_F_Obj_I _i = new Entities.Report_O_S_A_FT_F_Obj_I
        ...
        internal DataTable BuildDTResults()
        {
            ...
            _colum.DataType = System.Type.GetType("System.Int64");
            _colum.AllowDBNull = true;
            _colum.ColumnName = "IdOrganization";
            ...
            IEnumerable<System.Data.Common.DbDataRecord> _record = _dbReportGraphic.ReadTotals_Organization_by_Process(_ProcessGroupProcess.IdProcess, 
            ...
            foreach (System.Data.Common.DbDataRecord _dbRecord in _record)
            {
                _DTResults.Rows.Add(Convert.ToInt64(_dbRecord["IdOrganization"]),
        ...
        internal void Results_I(Entities.Report_O_S_A_FT_F_Obj_I i)
        {
            DataTable _result = DTResults;

            DataRow[] _dataRowResult = _result.Select("IdIndicator= " + i.Id.ToString() + " and IdOrganization = " + i.F.FT.A.S.O.Id.ToString() + " and IdScope= " + i.F.FT.A.S.Id.ToString() +
