...
{
    public class Report_FT_F_S_A_COL
    {
        ...
        internal Report_FT_F_S_A_COL(Entities.Report_FT_F_S_A report_FT_F_S_A, Int64 idIndicatortCO2e, Int64 idIndicatorCO2, Int64 idIndicatorCH4, Int64 idIndicatortnN2O,
                  ...
                  DateTime startDate, DateTime endDate)
        {
            ...
            _EndDate = endDate;
            _Credential = report_FT_F_S_A.Credential;
            _ProcessGroupProcess = report_FT_F_S_A.ProcessGroupProcess;
        }
        ...
        internal List<IColumnsReport> Ss(Entities.Report_FT_F_S_A_Obj_F f)
        {
            List<IColumnsReport> _oItems = new List<IColumnsReport>();
                ...
                foreach (PA.Entities.AccountingScope _scope in Scopes.Values)
                {
                    ...
                    Entities.Report_FT_F_S_A_Obj_S _s = new Entities.Report_FT_F_S_A_Obj_S(_scope.IdScope, _scope.LanguageOption.Name, f);
        ...
        internal List<IColumnsReport> As(Entities.Report_FT_F_S_A_Obj_S s)
        {
            List<IColumnsReport> _oItems = new List<IColumnsReport>();
                ...
                {
                    //Declara e instancia una posicion
                    Entities.Report_FT_F_S_A_Obj_A _a = new Entities.Report_FT_F_S_A_Obj_A
        ...
        internal List<IColumnsReport> As(Entities.Report_FT_F_S_A_Obj_A a)
        {
            List<IColumnsReport> _oItems = new List<IColumnsReport>();
        ...
        internal List<IColumnsReport> FTs()
        {
            List<IColumnsReport> _oItems = new List<IColumnsReport>();
                ...
                {                    
                    //Declara e instancia una posicion
                    Entities.Report_FT_F_S_A_Obj_FT _ft = new Entities.Report_FT_F_S_A_Obj_FT
                    (_facilitytype.IdFacilityType, _facilitytype.LanguageOption.Name, this);
        ...
        internal List<IColumnsReport> Fs(Entities.Report_FT_F_S_A_Obj_FT ft)
        {
            List<IColumnsReport> _oItems = new List<IColumnsReport>();
            //Objeto de data layer para acceder a datos
            DataAccess.RG.ReportGraphic _dbReportGraphic = new Condesus.EMS.DataAccess.RG.ReportGraphic();
            ...
            //filtra el datatable
            DataRow[] _dataRow = DTResults.Select("IdFacilityType = " + ft.Id.ToString());
            ...
            foreach (Int64 _idFacility in _listFacilities)
            {
                ...
                Entities.Report_FT_F_S_A_Obj_F _f = new Entities.Report_FT_F_S_A_Obj_F
                                                    (_idFacility,
        ...
        internal List<IColumnsReport> Is(Entities.Report_FT_F_S_A_Obj_A a)
        {
            List<IColumnsReport> _oItems = new List<IColumnsReport>();
            ...
            {
                //Declara e instancia una posicion
                Entities.Report_FT_F_S_A_Obj_I _i = new Entities.Report_FT_F_S_A_Obj_I
        ...
        internal void Results_I(Entities.Report_FT_F_S_A_Obj_I i)
        {
            DataTable _result = DTResults;

            DataRow[] _dataRowResult = _result.Select("IdIndicator= " + i.Id.ToString() + " and IdScope= " + i.A.S.Id.ToString() +
