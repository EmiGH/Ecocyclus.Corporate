...
{
    public class Report_S_A_FT_F_COL
    {
        ...
        internal Report_S_A_FT_F_COL(Entities.Report_S_A_FT_F report_S_A_FT_F, Int64 idIndicatortCO2e, Int64 idIndicatorCO2, Int64 idIndicatorCH4, Int64 idIndicatortnN2O,
                  ...
                  DateTime startDate, DateTime endDate)
        {
            ...
            _EndDate = endDate;
            _Credential = report_S_A_FT_F.Credential;
            _ProcessGroupProcess = report_S_A_FT_F.ProcessGroupProcess;
        }
        ...
        internal List<IColumnsReport> Ss()
        {
            ...
            foreach (PA.Entities.AccountingScope _scope in Scopes.Values)
            {
                ...
                Entities.Report_S_A_FT_F_Obj_S _s = new Entities.Report_S_A_FT_F_Obj_S(_scope.IdScope, _scope.LanguageOption.Name, this);
        ...
        internal List<IColumnsReport> As(Entities.Report_S_A_FT_F_Obj_S s)
        {
            List<IColumnsReport> _oItems = new List<IColumnsReport>();
                ...
                {
                    //Declara e instancia una posicion
                    Entities.Report_S_A_FT_F_Obj_A _a = new Entities.Report_S_A_FT_F_Obj_A
        ...
        internal List<IColumnsReport> As(Entities.Report_S_A_FT_F_Obj_A a)
        {
            List<IColumnsReport> _oItems = new List<IColumnsReport>();
        ...
        internal List<IColumnsReport> FTs(Entities.Report_S_A_FT_F_Obj_A a)
        {
            List<IColumnsReport> _oItems = new List<IColumnsReport>();
                ...
                {                    
                    //Declara e instancia una posicion
                    Entities.Report_S_A_FT_F_Obj_FT _ft = new Entities.Report_S_A_FT_F_Obj_FT
        ...
        internal List<IColumnsReport> Fs(Entities.Report_S_A_FT_F_Obj_FT ft)
        {
            List<IColumnsReport> _oItems = new List<IColumnsReport>();
            //Objeto de data layer para acceder a datos
            DataAccess.RG.ReportGraphic _dbReportGraphic = new Condesus.EMS.DataAccess.RG.ReportGraphic();
            ...
            //filtra el datatable
            DataRow[] _dataRow = DTResults.Select("IdFacilityType = " + ft.Id.ToString() + " and IdActivity= " + ft.A.Id.ToString() + " and IdScope= " + ft.A.S.Id.ToString());
            ...
            foreach (Int64 _idFacility in _listFacilities)
            {
                ...
                Entities.Report_S_A_FT_F_Obj_F _f = new Entities.Report_S_A_FT_F_Obj_F
                                                    (_idFacility,
        ...
        internal List<IColumnsReport> Is(Entities.Report_S_A_FT_F_Obj_F f)
        {
            List<IColumnsReport> _oItems = new List<IColumnsReport>();
            ...
            {
                //Declara e instancia una posicion
                Entities.Report_S_A_FT_F_Obj_I _i = new Entities.Report_S_A_FT_F_Obj_I
        ...
        internal void Results_I(Entities.Report_S_A_FT_F_Obj_I i)
        {
            DataTable _result = DTResults;

            DataRow[] _dataRowResult = _result.Select("IdIndicator= " + i.Id.ToString() + " and IdScope= " + i.F.FT.A.S.Id.ToString() +
