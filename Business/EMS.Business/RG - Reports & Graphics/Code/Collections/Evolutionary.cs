...
namespace Condesus.EMS.Business.RG.Collections
{
    public class Evolutionary
    {
        ...
        internal Evolutionary(PF.Entities.ProcessGroupProcess processGroupProcess,Int64 idIndicatortCO2e, Int64 idIndicatorCO2, Int64 idIndicatorCH4, Int64 idIndicatortnN2O,
        ...
        internal List<Entities.Evolutionary_O> Items(Int64 IdScope)
        {

            List<Entities.Evolutionary_O> _oItems = new List<Condesus.EMS.Business.RG.Entities.Evolutionary_O>();
            //Objeto de data layer para acceder a datos
            DataAccess.RG.ReportGraphic _dbReportGraphic = new Condesus.EMS.DataAccess.RG.ReportGraphic();

            IEnumerable<System.Data.Common.DbDataRecord> _record = _dbReportGraphic.ReadEvolutionary_Organization_by_Process(_ProcessGroupProcess.IdProcess, IdScope,
            ...
            {
                Entities.Evolutionary_O _evolutionary_O =new Entities.Evolutionary_O(Convert.ToInt64(_dbRecord["IdOrganization"]),
                                    Convert.ToInt16(_dbRecord["TimeYear"]),                                    
                                    ...
                                    _StartDate, _EndDate, _Credential);

                _oItems.Add(_evolutionary_O);
            }
