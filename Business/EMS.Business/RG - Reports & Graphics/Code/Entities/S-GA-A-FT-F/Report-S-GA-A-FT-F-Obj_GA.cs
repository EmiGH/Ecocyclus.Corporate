...
{
    public class Report_S_GA_A_FT_F_Obj_GA : IColumnsReport
    {
        ...
        private Report_S_GA_A_FT_F_Obj_S _S;
        ...
        internal Report_S_GA_A_FT_F_Obj_S S
        {
            get { return _S; }
        }
        ...
        {
            _Exist = false;
            DataRow[] _dataRow = COL.DTResults.Select("IdScope= " + this.S.Id.ToString() + " and IdGeographicArea= " + this.Id.ToString());
        ...
        internal Report_S_GA_A_FT_F_Obj_GA(Int64 id, String name, Report_S_GA_A_FT_F_Obj_S s)
        {
            _Id = id;
            _Name = name;
            _S = s;
