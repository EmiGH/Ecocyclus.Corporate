...
{
    public class Report_S_GA_A_FT_F
    {
        ...
        internal Report_S_GA_A_FT_F(Credential credential, PF.Entities.ProcessGroupProcess processGroupProcess)
        {
        ...
        public List<IColumnsReport> S(Int64 idIndicatortCO2e, Int64 idIndicatorCO2, Int64 idIndicatorCH4, Int64 idIndicatortnN2O,
            ...
            DateTime startDate, DateTime endDate)
        {
            ...
            Collections.Report_S_GA_A_FT_F_COL _report_S_GA_A_FT_F_COL = new Condesus.EMS.Business.RG.Collections.Report_S_GA_A_FT_F_COL(this, 
            ...
            return _report_S_GA_A_FT_F_COL.Ss();
