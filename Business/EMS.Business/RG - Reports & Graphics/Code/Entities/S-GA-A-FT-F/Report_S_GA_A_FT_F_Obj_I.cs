...
{
    public class Report_S_GA_A_FT_F_Obj_I : IColumnsReport
    {
        ...
        private Report_S_GA_A_FT_F_Obj_F _F;
        ...
        internal Report_S_GA_A_FT_F_Obj_F F
        {
            get { return _F; }
        }
        ...
        internal Report_S_GA_A_FT_F_Obj_I(Int64 id, String name, Report_S_GA_A_FT_F_Obj_F f)
        {
            _Id = id;
            _Name = name;
            _F = f;
