...
{
    public class Report_S_GA_A_FT_F_Obj_A : IColumnsReport
    {
        ...
        private Report_S_GA_A_FT_F_Obj_GA _GA;
        ...
        internal Report_S_GA_A_FT_F_Obj_GA GA
        {
            get { return _GA; }
        }
        ...
        {
            _Exist = false;
            DataRow[] _dataRow = COL.DTResults.Select("IdGeographicArea= " + this.GA.Id.ToString() + " and IdScope= " + this.GA.S.Id.ToString() + " and IdActivity= " + this.Id.ToString());
        ...
        internal Report_S_GA_A_FT_F_Obj_A(Int64 id, String name, Report_S_GA_A_FT_F_Obj_GA ga)
        {
            _Id = id;
            _Name = name;
            _GA = ga;
