...
{
    public class Report_S_GA_A_FT_F_Obj_S : IColumnsReport
    {
        ...
        private Collections.Report_S_GA_A_FT_F_COL _COL;
        ...
        {
            _Exist = false;
            DataRow[] _dataRow = COL.DTResults.Select("IdScope= " + this.Id.ToString());
        ...
        internal Report_S_GA_A_FT_F_Obj_S(Int64 id, String name, Collections.Report_S_GA_A_FT_F_COL col)
        {
