...
{
    public class Report_O_S_A_FT_F_Obj_O : IColumnsReport
    {
        ...
        private Collections.Report_O_S_A_FT_F_COL _COL;
        ...
        {
            _Exist = false;
            DataRow[] _dataRow = COL.DTResults.Select("IdOrganization= " + this.Id.ToString());
        ...
        internal Report_O_S_A_FT_F_Obj_O(Int64 id, String name, Collections.Report_O_S_A_FT_F_COL col)
        {
            _Id = id;
            _Name = name;
            _COL = col;
