...
{
    public class Report_O_S_A_FT_F_Obj_S : IColumnsReport
    {
        ...
        private Report_O_S_A_FT_F_Obj_O _O;
        ...
        internal Report_O_S_A_FT_F_Obj_O O
        {
            get { return _O; }
        }
        ...
        {
            _Exist = false;
            DataRow[] _dataRow = COL.DTResults.Select("IdOrganization= " + this.O.Id.ToString() + " and IdScope= " + this.Id.ToString());
        ...
        internal Report_O_S_A_FT_F_Obj_S(Int64 id, String name, Report_O_S_A_FT_F_Obj_O o)
        {
