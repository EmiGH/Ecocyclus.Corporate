...
{
    public class Report_O_S_A_FT_F_Obj_A : IColumnsReport
    {
        ...
        private Report_O_S_A_FT_F_Obj_S _S;
        ...
        internal Report_O_S_A_FT_F_Obj_S S
        {
            get { return _S; }
        }
        ...
        {
            _Exist = false;
            DataRow[] _dataRow = COL.DTResults.Select("IdOrganization= " + this.S.O.Id.ToString() + " and IdScope= " + this.S.Id.ToString() + " and IdActivity= " + this.Id.ToString());
        ...
        internal Report_O_S_A_FT_F_Obj_A(Int64 id, String name, Report_O_S_A_FT_F_Obj_S s)
        {
            _Id = id;
            _Name = name;
            _S = s;
