...
{
    public class Report_FT_F_S_A_Obj_F : IColumnsReport
    {
        ...
        private Report_FT_F_S_A_Obj_FT _FT;
        ...
        internal Report_FT_F_S_A_Obj_FT FT
        {
            get { return _FT; }
        }
        ...
        {
            _Exist = false;
            DataRow[] _dataRow = COL.DTResults.Select("IdFacilityType = " + this.FT.Id.ToString() + " and IdFacility = " + this.Id.ToString());
        ...
        internal Report_FT_F_S_A_Obj_F(Int64 id, String name, Report_FT_F_S_A_Obj_FT ft)
        {
            _Id = id;
            _Name = name;           
            _FT = ft;
