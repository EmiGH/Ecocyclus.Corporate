...
{
    public class Report_FT_F_S_A_Obj_FT : IColumnsReport
    {
        ...
        private Collections.Report_FT_F_S_A_COL _COL;
        ...
        {
            _Exist = false;
            DataRow[] _dataRow = COL.DTResults.Select("IdFacilityType = " + this.Id.ToString());
        ...
        internal Report_FT_F_S_A_Obj_FT(Int64 id, String name, Collections.Report_FT_F_S_A_COL col)
        {
            _Id = id;
            _Name = name;
            _COL = col;
