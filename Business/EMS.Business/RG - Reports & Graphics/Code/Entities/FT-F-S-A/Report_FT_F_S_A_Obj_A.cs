...
{
    public class Report_FT_F_S_A_Obj_A : IColumnsReport
    {
        ...
        private Report_FT_F_S_A_Obj_S _S;
        ...
        internal Collections.Report_FT_F_S_A_COL COL
        {
            get { return S.COL; }
        }
        internal Report_FT_F_S_A_Obj_S S
        {
            get { return _S; }
        }
        ...
        {
            _Exist = false;
            DataRow[] _dataRow = COL.DTResults.Select("IdFacilityType = " + this.S.F.FT.Id.ToString() + " and IdFacility = " + this.S.F.Id.ToString() + " and IdScope = " + this.S.Id.ToString() + " and IdActivity = " + this.Id.ToString());
        ...
        private void LoadingResults()
        {
            ...
            //{
                ...
                foreach (IColumnsReport _obj in Child())
                {
                    _Result_C2H6 = _Result_C2H6 + _obj.Result_C2H6;
                    _Result_C3H8 = _Result_C3H8 + _obj.Result_C3H8;
                    _Result_C4H10 = _Result_C4H10 + _obj.Result_C4H10;
        ...
        internal Report_FT_F_S_A_Obj_A(Int64 id, String name, Report_FT_F_S_A_Obj_S s)
        {
            _Id = id;
            _Name = name;
            _S = s;
