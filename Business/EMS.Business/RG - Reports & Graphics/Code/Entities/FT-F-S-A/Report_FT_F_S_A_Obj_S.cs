...
{
    public class Report_FT_F_S_A_Obj_S : IColumnsReport
    {
        ...
        private Report_FT_F_S_A_Obj_F _F;
        ...
        internal Report_FT_F_S_A_Obj_F F
        {
            get { return _F; }
        }
        ...
        {
            _Exist = false;
            DataRow[] _dataRow = COL.DTResults.Select("IdFacilityType = " + this.F.FT.Id.ToString() + " and IdFacility = " + this.F.Id.ToString() + " and IdScope = " + this.Id.ToString());
        ...
        internal Report_FT_F_S_A_Obj_S(Int64 id, String name, Report_FT_F_S_A_Obj_F f)
        {
