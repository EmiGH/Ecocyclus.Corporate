...
{
    public class Graphic_Bar_FT : IGraphicBar
    {
        ...
        internal Graphic_Bar_FT(Int64 id, String name, Decimal Result_tCO2e, Decimal Result_CO2, Decimal Result_CH4, Decimal Result_N2O,
