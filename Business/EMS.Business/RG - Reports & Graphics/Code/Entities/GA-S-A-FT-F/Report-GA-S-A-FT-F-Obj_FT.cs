...
{
    public class Report_GA_S_A_FT_F_Obj_FT : IColumnsReport
    {
        ...
        private Report_GA_S_A_FT_F_Obj_A _A;
        ...
        internal Collections.Report_GA_S_A_FT_F_COL COL
        {
            get { return A.COL; }
        }
        internal Report_GA_S_A_FT_F_Obj_A A
        {
            get { return _A; }
        }
        ...
        {
            _Exist = false;
            DataRow[] _dataRow = COL.DTResults.Select("IdGeographicArea= " + this.A.S.GA.Id.ToString() + " and IdScope= " + this.A.S.Id.ToString() + " and IdActivity= " + this.A.Id.ToString() + " and IdFacilityType= " + this.Id.ToString());
        ...
        internal Report_GA_S_A_FT_F_Obj_FT(Int64 id, String name, Report_GA_S_A_FT_F_Obj_A a)
        {
            _Id = id;
            _Name = name;            
            _A = a;
