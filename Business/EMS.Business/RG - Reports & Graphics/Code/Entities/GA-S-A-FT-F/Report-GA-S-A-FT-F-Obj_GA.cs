...
{
    public class Report_GA_S_A_FT_F_Obj_GA : IColumnsReport
    {
        ...
        private Collections.Report_GA_S_A_FT_F_COL _COL;
        ...
        {
            _Exist = false;
            DataRow[] _dataRow = COL.DTResults.Select("IdGeographicArea= " + this.Id.ToString());
        ...
        internal Report_GA_S_A_FT_F_Obj_GA(Int64 id, String name, Collections.Report_GA_S_A_FT_F_COL col)
        {
            _Id = id;
            _Name = name;
            _COL = col;
