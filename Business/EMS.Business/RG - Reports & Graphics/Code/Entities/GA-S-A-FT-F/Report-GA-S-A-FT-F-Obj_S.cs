...
{
    public class Report_GA_S_A_FT_F_Obj_S : IColumnsReport
    {
        ...
        private Report_GA_S_A_FT_F_Obj_GA _GA;
        ...
        internal Report_GA_S_A_FT_F_Obj_GA GA
        {
            get { return _GA; }
        }
        ...
        {
            _Exist = false;
            DataRow[] _dataRow = COL.DTResults.Select("IdGeographicArea= " + this.GA.Id.ToString() + " and IdScope= " + this.Id.ToString());
        ...
        internal Report_GA_S_A_FT_F_Obj_S(Int64 id, String name, Report_GA_S_A_FT_F_Obj_GA ga)
        {
