...
{
    public class Report_GA_FT_F_S_A_Obj_F : IColumnsReport
    {
        ...
        private Report_GA_FT_F_S_A_Obj_FT _FT;
        ...
        internal Report_GA_FT_F_S_A_Obj_FT FT
        {
            get { return _FT; }
        }
        ...
        {
            _Exist = false;
            DataRow[] _dataRow = COL.DTResults.Select("IdGeographicArea= " + this.FT.GA.Id.ToString() + " and IdFacilityType = " + this.FT.Id.ToString() + " and IdFacility = " + this.Id.ToString());
        ...
        internal Report_GA_FT_F_S_A_Obj_F(Int64 id, String name, Report_GA_FT_F_S_A_Obj_FT ft)
        {
            _Id = id;
            _Name = name;           
            _FT = ft;
