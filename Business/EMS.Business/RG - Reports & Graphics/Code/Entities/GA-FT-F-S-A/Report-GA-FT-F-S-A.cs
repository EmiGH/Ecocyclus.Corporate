...
{
    public class Report_GA_FT_F_S_A
    {
        ...
        internal Report_GA_FT_F_S_A(Credential credential, PF.Entities.ProcessGroupProcess processGroupProcess)
        {
        ...
        public List<IColumnsReport> GA(Int64 idIndicatortCO2e, Int64 idIndicatorCO2, Int64 idIndicatorCH4, Int64 idIndicatortnN2O,
            ...
            DateTime startDate, DateTime endDate)
        {
            ...
            Collections.Report_GA_FT_F_S_A_COL _report_GA_FT_F_S_A_COL = new Condesus.EMS.Business.RG.Collections.Report_GA_FT_F_S_A_COL(this, 
            ...
            return _report_GA_FT_F_S_A_COL.GAs();
