...
{
    public class Report_GA_FT_F_S_A_Obj_I : IColumnsReport
    {
        ...
        private Report_GA_FT_F_S_A_Obj_A _A;
        ...
        internal Report_GA_FT_F_S_A_Obj_A A
        {
            get { return _A; }
        }
        ...
        internal Report_GA_FT_F_S_A_Obj_I(Int64 id, String name, Report_GA_FT_F_S_A_Obj_A a)
        {
            _Id = id;
            _Name = name;
            _A = a;
