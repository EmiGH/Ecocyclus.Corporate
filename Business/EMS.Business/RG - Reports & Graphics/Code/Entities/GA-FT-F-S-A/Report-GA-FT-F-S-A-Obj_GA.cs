...
{
    public class Report_GA_FT_F_S_A_Obj_GA : IColumnsReport
    {
        ...
        private Collections.Report_GA_FT_F_S_A_COL _COL;
        ...
        internal Report_GA_FT_F_S_A_Obj_GA(Int64 id, String name, Collections.Report_GA_FT_F_S_A_COL col)
        {
            _Id = id;
            _Name = name;
            _COL = col;
