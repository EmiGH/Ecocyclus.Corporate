...
{
    public class Report_GA_FT_F_S_A_Obj_A : IColumnsReport
    {
        ...
        private Report_GA_FT_F_S_A_Obj_S _S;
        ...
        {
            get { return S.Credential; }
        }
        internal Collections.Report_GA_FT_F_S_A_COL COL
        {
            get { return S.COL; }
        }
        internal Report_GA_FT_F_S_A_Obj_S S
        {
            get { return _S; }
        }
        ...
        internal Report_GA_FT_F_S_A_Obj_A(Int64 id, String name, Report_GA_FT_F_S_A_Obj_S s)
        {
            _Id = id;
            _Name = name;
            _S = s;
