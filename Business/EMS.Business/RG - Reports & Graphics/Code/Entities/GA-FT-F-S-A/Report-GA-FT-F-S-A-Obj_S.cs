...
{
    public class Report_GA_FT_F_S_A_Obj_S : IColumnsReport
    {
        ...
        private Report_GA_FT_F_S_A_Obj_F _F;
        ...
        {
            get { return F.Credential; }
        }
        internal Collections.Report_GA_FT_F_S_A_COL COL
        {
            get { return F.COL; }
        }
        internal Report_GA_FT_F_S_A_Obj_F F
        {
            get { return _F; }
        }
        ...
        {
            _Exist = false;
            DataRow[] _dataRow = COL.DTResults.Select("IdGeographicArea= " + this.F.FT.GA.Id.ToString() + " and IdFacilityType = " + this.F.FT.Id.ToString() + " and IdFacility = " + this.F.Id.ToString() + " and IdScope = " + this.Id.ToString());
        ...
        internal Report_GA_FT_F_S_A_Obj_S(Int64 id, String name, Report_GA_FT_F_S_A_Obj_F f)
        {
