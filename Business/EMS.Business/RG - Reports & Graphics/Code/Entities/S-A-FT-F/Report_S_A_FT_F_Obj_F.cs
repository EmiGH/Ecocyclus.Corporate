...
{
    public class Report_S_A_FT_F_Obj_F : IColumnsReport
    {
        ...
        private Report_S_A_FT_F_Obj_FT _FT;
        ...
        internal Report_S_A_FT_F_Obj_FT FT
        {
            get { return _FT; }
        }
        ...
        internal Report_S_A_FT_F_Obj_F(Int64 id, String name, Report_S_A_FT_F_Obj_FT ft)
        {
            _Id = id;
            _Name = name;           
            _FT = ft;
