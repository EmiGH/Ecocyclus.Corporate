...
namespace Condesus.EMS.Business.RG.Entities
{
    public class Report_S_A_FT_F
    {
        ...
        internal Report_S_A_FT_F(Credential credential, PF.Entities.ProcessGroupProcess processGroupProcess)
        {
            ...
            DateTime startDate, DateTime endDate)
        {
            ...
            Collections.Report_S_A_FT_F_COL _report_S_A_FT_F_COL = new Condesus.EMS.Business.RG.Collections.Report_S_A_FT_F_COL(this, 
            ...
            return _report_S_A_FT_F_COL.Ss();
