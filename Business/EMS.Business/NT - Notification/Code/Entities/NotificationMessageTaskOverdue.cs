...
{
    public class NotificationMessageTaskOverdue : NotificationMessage
    {
        ...
        { get { return Common.Resources.ConstantMessage.Subject_NotificationMessageTaskOverdue; } }
        ...
        internal NotificationMessageTaskOverdue(IA.Entities.ExceptionProcessTask exception)
            : base ()
        {
