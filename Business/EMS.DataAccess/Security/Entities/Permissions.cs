...
namespace Condesus.EMS.DataAccess.Security.Entities
{
    internal class Permissions
    {
        ...
        internal IEnumerable<DbDataRecord> ReadAll(String idLanguage)
        {
            ...
            DbCommand _dbCommand = _db.GetStoredProcCommand("SS_SecurityPermissions_ReadAll");
        ...
        internal IEnumerable<DbDataRecord> ReadById(Int64 idPermission, String idLanguage)
        {
            ...
            DbCommand _dbCommand = _db.GetStoredProcCommand("SS_SecurityPermissions_ReadById");
